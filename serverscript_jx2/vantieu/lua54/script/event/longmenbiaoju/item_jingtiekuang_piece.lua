...
TB_DEST_ITEM = {tbProp = {6, 1, 4985, 1,0, 0}, szName="Tinh Thi’t Kho∏ng kh´ng nguy™n ch t.", nCount=1, nBindState = -2}
NEED_ROOM = 1
NEED_COUNT = 10
TB_NEED_ITEM = {tbProp = {6, 1, 4983, 1,0, 0}, szName="M∂nh Tinh Thi’t Kho∏ng"}
