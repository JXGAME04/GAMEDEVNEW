...
function HD3_ADM_ST_Boot() HD3_DriverInit() Msg2Player("ß∑ g‰i HD3_DriverInit (sinh NPC + boss). G‰i l∆p sœ nh©n b∂n NPC!") end
...
function HD3_ADM_PLD_LB() AddItem(4, 489, 0, 0, 0, 0) Msg2Player("ß∑ nhÀn L÷nh bµi Phong L®ng ßÈ.") end
function HD3_ADM_PLD_LBTT() AddItem(6, 1, 3363, 0, 0, 0) Msg2Player("ß∑ nhÀn L÷nh Bµi ThÒy T∆c (6,1,3363).") end
