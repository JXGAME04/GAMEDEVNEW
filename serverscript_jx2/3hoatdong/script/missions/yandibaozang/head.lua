...
YDBZ_LIMIT_ITEM					= {{6,1,1613},1,"Anh Hïng ThiÕp"}	--ĞèÒªĞÅÎï£¬Ó¢ĞÛÌû£¬tb1£¬Í¼Æ×ID£¬tb2£¬ĞèÒªÊıÁ¿
...
{
	[1] = {"H×nh nh©n",6,1,1614}, -- 1¹Ì¶¨Îª¿şÀÜ
...
YDBZ_tbaward_item ={
	...
	{--¼¸ÂÊ%,¸öÊı,ÎïÆ·ID,ÊÇ·ñµôµØÉÏ(0,µôµØÉÏ£¬1Ö±½ÓËæ»úµôÒ»¸ö¶ÓÔ±ÉíÉÏ),Ãû³Æ,Ë«±¶ÍèÊÇ·ñÓĞĞ§
		{50,1,{6,1,1614,1,0,0},1,"H×nh nh©n",1},		--¿şÀÜ
		{100,15,{1, 2, 0, 5, 0, 0},0,"Ngò Hoa Ngäc Lé Hoµn",0}, --Îå»¨
		--{10,1,{6,1,1615,1,0,0},1,"Viªm §Õ §å §»ng",1},			--ËéÆ¬
	},
	[3]=--Õù¶áµØĞ¡boss
	{
		{100,1,{6,1,1614,1,0,0},1,"H×nh nh©n",1},		--¿şÀÜ
		{100,30,{1, 2, 0, 5, 0, 0},0,"Ngò Hoa Ngäc Lé Hoµn",0},--Îå»¨
	},
--Modifiled by:ThanhLD - 20140226 - change award from Boss cuèi tİnh n¨ng Viªm §Õ
	[4]=--×îÖÕboss
	{	
		[1] = {--PhÇn 1
		...
		[2] = {--PhÇn 2
			{szName="Hép MÆt N¹ ChiÕn Tr­êng",tbProp={6,1,30350,1,0,0},nCount=1,nRate=11.15,nExpiredTime=10080,tbParam={1,10080,60,0,0,0}},
			{szName="Hép MÆt N¹ ChiÕn Tr­êng",tbProp={6,1,30350,1,0,0},nCount=1,nRate=2.57,nExpiredTime=10080,tbParam={2,10080,60,0,0,0}},
			{szName="Phi phong Ngù Phong (Träng kİch)",tbProp={0,3475},nCount=1,nRate=3,nQuality = 1,nExpiredTime=10080,},
			{szName="Phi phong Ngù Phong (X¸c suÊt hãa gi¶i s¸t th­¬ng)",tbProp={0,3474},nCount=1,nRate=2.1,nQuality = 1,nExpiredTime=10080,},
			{szName="Phi Phong PhÖ Quang ( träng kİch)",tbProp={0,3478},nCount=1,nRate=1.5,nQuality = 1,nExpiredTime=10080,},
		...
		[4] = {--PhÇn 4
			{szName = "§å Phæ §»ng Long Béi", tbProp = {6, 1, 30534,1,0,0}, nRate = 0.1,},
			{szName="§»ng Long Th¹ch - H¹",tbProp={6,1,30538,1,0,0},nCount=5,nRate=2},
			{szName = "§å Phæ Tinh S­¬ng Yªu §¸i", tbProp = {6, 1, 30008,1,0,0}, nRate = 0.11,},
			{szName = "§å Phæ Tinh S­¬ng Béi", tbProp = {6, 1, 30011,1,0,0}, nRate = 0.11,},
		},
	},
}
...
{
	[1] = {szName="Viªm §Õ Bİ B¶o",tbProp={6,1,3423,1,0,0}},		-- Ñ×µÛÃØ±¦pÓĞ´ıĞŞ¸Ä
}
