...
YDBZ_item_suipian_ID = {6, 1, 1615}		--ID
YDBZ_tbgolditem = {
	[1]={--IDg,d,p
			"Bé trang bÞ To¹i Nh©n [Kim]",	
			{"To¹i Nh©n XÝch HuyÕt Nguyªn Vò Gi¸p",50,6,1,1536,"{{Sinh lùc lín nhÊt}}180-240<enter>{{Gi¶m bít thêi gian ®éng t¸c s¸t th­¬ng}}45-55<enter>{{Gi¶m thêi gian cho¸ng}}30-50<enter>{{TrÞ phßng háa lín nhÊt}}25-30<enter>{{PhÇn tr¨m s¸t th­¬ng vËt lý hÖ ngo¹i c«ng}}30-50"},
			{"To¹i Nh©n B¸ch LuyÖn Kh«i",45,6,1,1537,"<enter>{{Sinh lùc lín nhÊt}}180-240<enter>{{Háa phßng lín nhÊt}}25-30<enter>{{Néi lùc lín nhÊt}}180-240<enter>{{Gi¶m thêi gian ®ãng b¨ng}}30-50<enter>{{PhÇn tr¨m s¸t th­¬ng vËt lý hÖ ngo¹i c«ng}}30-50"},
	...
	[2]={
			...
			{"Phôc Hi Hoan ¶nh KÞch",38,6,1,1549,"{{Sinh lùc lín nhÊt}}180-240<enter>{{T¨ng tèc ®é di chuyÓn}}40-50<enter>{{Néi lùc lín nhÊt}}180-240<enter>{{B¨ng phßng lín nhÊt}}25-30<enter>{{PhÇn tr¨m s¸t th­¬ng vËt lý hÖ ngo¹i c«ng}}30-50"},	
			{"Phôc Hi V« L­îng TÞch Tµ Thñ",38,6,1,1550,"{{Sinh lùc lín nhÊt}}180-240<enter>{{B¨ng phßng lín nhÊt}}25-30<enter>{{Néi lùc lín nhÊt}}180-240<enter>{{Gi¶m thêi gian cho¸ng}}30-50<enter>{{T¨ng s¸t th­¬ng chÝ m¹ng}}3-5"},	
	...
	[3]={
			...
			{"N÷ Oa Hång Nhan Ph¸t §¸i",38,6,1,1557,"{{Sinh lùc lín nhÊt}}180-240<enter>{{Phæ phßng lín nhÊt}}25-30<enter>{{Néi lùc lín nhÊt}}180-240<enter>{{Gi¶m thêi gian cho¸ng}}30-50<enter>{{PhÇn tr¨m s¸t th­¬ng vËt lý hÖ ngo¹i c«ng}}30-50"},	
	...
	[4]={
			...
			{"Chóc Dung LiÖt DiÖm Né Phong Trang",45,6,1,1566,"{{Sinh lùc lín nhÊt}}180-240<enter>{{Gi¶m thêi gian ®éng t¸c bÞ th­¬ng}}45-55<enter>{{Gi¶m thêi gian tróng ®éc}}30-50<enter>{{Phæ phßng lín nhÊt}}25-30<enter>{{S¸t th­¬ng chuyÓn thµnh néi c«ng}}6-10"},	
			{"Chóc Dung Kinh ChÝch BÊt DiÖt Tr¶o",38,6,1,1570,"{{Sinh lùc lín nhÊt}}180-240<enter>{{Phæ phßng lín nhÊt}}25-30<enter>{{Néi lùc lín nhÊt}}180-240<enter>{{Gi¶m thêi gian ®ãng b¨ng}}30-50<enter>{{T¨ng b¨ng s¸t hÖ néi c«ng}}80-120"},	
	...
	[5]={
			...
			{"ThÇn N«ng Tiªu D­¬ng §Þa Hoµng Y",50,6,1,1576,"{{Sinh lùc lín nhÊt}}180-240<enter>{{Gi¶m thêi gian ®éng t¸c bÞ th­¬ng}}45-55<enter>{{Gi¶m thêi gian cho¸ng}}30-50<enter>{{Phæ phßng lín nhÊt}}25-30<enter>{{PhÇn tr¨m s¸t th­¬ng vËt lý hÖ ngo¹i c«ng}}30-50"},	
...
function YDBZ_golditem_get(nchose,ni)
	local nlen = getn(YDBZ_tbgolditem[nchose])
	local tbfun =  {}
	tbfun[1] = format("<dec><npc>C¸c h¹ muèn <color=yellow>®å phæ %s<color> cña <color=yellow>%s<color> cÇn ph¶i cã <color=yellow>%s<color> viªm ®Õ ®å ®»ng míi cã thÓ ®æi ®­îc. C¸c h¹ muèn ®æi kh«ng?<enter>Sau khi ghÐp ®å phæ xong th× thuéc tÝnh trang bÞ nh­ bªn d­íi: <enter>%s",YDBZ_tbgolditem[nchose][1],YDBZ_tbgolditem[nchose][ni][1],YDBZ_tbgolditem[nchose][ni][2],YDBZ_tbgolditem[nchose][ni][6])
