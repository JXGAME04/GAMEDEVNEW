...
function YDBZ_SureDoTradeLingQi(n_sel)
	local tbFormula = {
			[1] = {
						tbMaterial = {{tbProp = {6, 1, 1615, -1}, szName = "Viªm §Õ §å §»ng", nCount = 2}},
						tbProduct = {tbProp = {6, 1, 2541,1,0,0}, szName = "Viªm §Õ LÖnh Kú"},
			},
			[2] = {
						tbMaterial = {
							{tbProp = {6, 1, 1615, -1}, szName = "Viªm §Õ §å §»ng", nCount = 2},
