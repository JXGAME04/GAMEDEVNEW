...
function BDH_P_Root()
	SayEx({format("Pet PC: cã=%d gäi=%d cÊp=%d - ®iÓm %d/%d/%d/%d",
...
function BDH_P_CapDo()
	...
	Msg2Player("§· cÊp ThiÖp §ång Hµnh + 10 Thuèc T¨ng Tr­ëng + 4 tr¸i c©y.")
end
