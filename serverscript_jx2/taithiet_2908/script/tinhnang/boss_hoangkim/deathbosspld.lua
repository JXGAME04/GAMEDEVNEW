...
KILLBOSSEXPAWARD 			= BHK_CFG("BHK_EXP_GIET_BOSS_PLD", 50000000) * EXP_RATE
KILLBOSSNEAREXPAWARD 	= BHK_CFG("BHK_EXP_LANCAN_BOSS_PLD", 20000000) * EXP_RATE
PHAMVI_HUONGEXP 				= BHK_CFG("BHK_PHAMVI_HUONG_EXP_PLD", 200)
