...
-- 4×ªĞèÒªµÄÆäËûµÀ¾ß
TBITEMNEED_4 = {
	[1] = {szName = "Tİch LŞch ®¬n", tbProb = {6,1,3591}, nCount = 999},	-- Åùö¨µ¯
	[2] = {szName = "<B¾c §Èu Tr­êng Sinh ThuËt—§¹i Thõa T©m Ph¸p>", tbProb = {6,1,3592}, nCount = 1},  -- ±±¶·³¤ÉúÊõ¡ª´ó³ËĞÄ·¨
	}
...
TBITEMNEED_5 = {
	...
	[1] = {szName = "ChuyÓn sinh thuËt(cÊp 5)", tbProb = {6,1,30246}, nCount = 2},  -- ±±¶·³¤ÉúÊõ¡ª´ó³ËĞÄ·¨
	}
...
--	[17]= format("<dec><npc>Trïng sinh 5 cÇn cã<color=red>%d<color> c¸i %s, Xin h·y chuÈn bŞ ®ñ råi ®Õn ®©y.", TBITEMNEED_5[2].nCount, TBITEMNEED_5[2].szName),
--  [18]= format("<dec><npc>Trïng sinh 5 cÇn cã<color=red>%s<color>, Xin h·y chuÈn bŞ ®ñ råi ®Õn ®©y.", TBITEMNEED_5[3].szName),
	[17]= "",
	[18]= "",
