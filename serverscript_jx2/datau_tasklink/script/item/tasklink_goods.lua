-- Cuon Dia Do Chi (6/1/205) - cong task 1025 hoac manh SHXT 1027
	...
	if (myTaskType == 4) then
		...
		if (nt_getTask(1031) == myMapID) then
			...
			if (GetByte(nt_getTask(1032),1) == 1) then
				...
				Msg2Player("B\185n nh\203n \174\173\238c m\233t t\202m".." <color=Yellow>".."\167\222a \167\229 Ch\216".." <color>".."t\185i"..
