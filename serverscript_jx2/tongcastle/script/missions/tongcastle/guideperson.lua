...
JOIN_TONG_TIME = 60*24
TRANSLIFE_COUNT = 4
MIN_LEVEL = 150
MIN_STAY_TIME = 45

AWARD_STATE_TIME = 1900
AWARD_END_TIME = 2400

-- [TONGCASTLE 23/08] chinh sach: bo trung sinh 4 + cap 150, giu 'vao bang > 1 ngay'
MSG_PLAYER_LIMIT = "Ph¶i ®¹t cÊp 90 trë lªn vµ vµo bang nhiÒu h¬n 1 ngµy míi cã thÓ tham gia Bang Héi Thµnh B¶o"

local tbTreeItem = {
	[1] = {szName = "Thanh §ång ThÇn Méc LÖnh", nId = 3205, nPrice = 10,},
	[2] = {szName = "B¹ch Ng©n ThÇn Méc LÖnh", nId = 3206, nPrice = 20,},
	[3] = {szName = "Hoµng Kim ThÇn Méc LÖnh", nId = 3207, nPrice = 120,},
}
...
function s2rExchangeTreePoint()
	...
	if nCurTime < %AWARD_STATE_TIME or nCurTime >= %AWARD_END_TIME then
		Talk(1, "", "ChØ cã thÓ nhËn ®iÓm ThÇn Méc vµo lóc 19:00 ®Õn 24:00.")
		return
	end
