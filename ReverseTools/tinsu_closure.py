...
ROOTS = ["task/tollgate/messenger", "item/messenger", "item/xinshirenwu"]
ROOTFILES = ["task/tollgate/addtollgatenpc.lua", "task/tollgate/killbosshead.lua", "task/tollgate/messenger_prize.lua"]
SKIP = {"task/partner/master/partner_master_main.lua"}   # JX2 PARTNER - se comment Include
