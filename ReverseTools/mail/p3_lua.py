...
def build_mailmanager():
    L = [
        ...
        "                MailManager_SendMail(GetName(), MAILMGR_SENDER_SYS, \"" + V("Vật phẩm đấu giá gửi lại") + "\",",
        "                    \"" + V("Lần nhận trước hành trang không đủ chỗ, vật phẩm được gửi lại đây.") + "\",",
        ...
        "                Msg2Player(\"" + V("Vật phẩm đấu giá không còn trong kho, hãy báo quản trị!") + "\")",
        "                return",
        "            end",
        "            a.szRec = ai.rec",
        "            if AUC_CanGiveRec and AUC_CanGiveRec(ai.rec) ~= 1 then",
        "                Msg2Player(\"" + V("Hành trang không còn khoảng trống liền đủ rộng cho vật phẩm này, hãy dọn bớt!") + "\")",
        "                return",
        "            end",
        "        end",
        "    end",
