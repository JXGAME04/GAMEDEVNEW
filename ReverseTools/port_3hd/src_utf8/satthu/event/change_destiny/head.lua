...
tbChangeDestiny = 
{
	...
	tbMissionInfo = 
	{
		[0] = {3,	"Trong một trận Tống Kim cao cấp thu được 3000 điểm tích lũy",				"Đại hiệp đã nhận nhiệm vụ 3000 điểm tích lũy Tống Kim ở Thần Nông Lão Gia",	},
		[1] = {1,	"ở nhiệm vụ vượt ải cao cấp đã đánh bại Nhiếp Thí Trần",						"Đại hiệp đã nhận nhiệm vụ đánh bại Nhiếp Thí Trần ở Thần Nông Lão Gia",			},
		[2] = {2,	"Đã đánh bại Thủy Tặc Đầu Lĩnh ở Phong Lăng Độ.",							"Đại hiệp đã nhận nhiệm vụ đánh bại Thủy Tặc Đầu Lĩnh ở Thần Nông Lão Gia.",		},
		[3] = {3,	"Nhiệm vụ đánh bại 4 lần sát thủ cấp 90 (Nhiệm vụ này nhận Nhiếp Thí Trần)",	"Đại hiệp đã nhận nhiệm vụ đánh bại tứ đại sát thủ ở Thần Nông Lão Gia",		},
	},
