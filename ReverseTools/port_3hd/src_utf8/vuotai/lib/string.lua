...
function toSeries(sno, bUnColorful)
	...
	if(sno < 0 or sno > 4) then return "Vô hệ " end
...
---将等级数字转换成彩色等级汉字
LEVELWORD = {
	"<color="..toColor(200,200,200).."> cấp1 <color>",
	"<color="..toColor(0,200,0).."> cấp2 <color>",
	"<color="..toColor(200,0,0).."> cấp3 <color>",
	"<color="..toColor(200,0,200).."> cấp4 <color>",
	"<color="..toColor(200,200,0).."> cấp5 <color>",
	"<color="..toColor(0,0,255).."> cấp6 <color>",
	"<color="..toColor(0,255,0).."> cấp7 <color>",
	"<color="..toColor(255,0,0).."> cấp8 <color>",
	"<color="..toColor(255,0,255).."> cấp9 <color>",
	"<color="..toColor(255,255,0).."> cấp10 <color>",	
}

function toLevel(lvl)
	if(not tonumber(lvl)) then return "error" end
	if(lvl < 0 or lvl > 10) then return "Chưa biết" end
