...
function start_match()
	...
	if (player_count == 0) then
		...
		-- 通告
		broadcast("Nhiệm vụ 'Thách thức Thời gian' đã chính thức bắt đầu, anh hùng các nơi đang ra sức tranh tài");
		...
		WriteLog(format("Tiểu Nhiếp Thí Trần xuất hiện thẻ ải là %d",nBossBatch))
