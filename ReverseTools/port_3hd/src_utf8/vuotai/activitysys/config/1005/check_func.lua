...
--	local nBitVal1 = %tbExtPointLib:GetBitValue(%nEXT_POINT_ID, %nEXT_POINT_BIT_NEW_ACCOUNT) --nạp code tài khoản mới
--	local nBitVal2 = %tbExtPointLib:GetBitValue(%nEXT_POINT_ID, %nEXT_POINT_BIT_OLD_ACCOUNT)--nạp code tài khoản cũ
--	local nBitVal3 = %tbExtPointLib:GetBitValue(%nEXT_POINT_ID, %nEXT_POINT_BIT_USER_ACTIVE_IN_GAME)--đã nhận thưởng
