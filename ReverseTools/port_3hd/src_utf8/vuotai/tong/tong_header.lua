...
TB_WEEKGOAL_TYPE_NAME	=	{ "Chiến trường Tống Kim",	"Nhiệm vụ Tín Sứ ",	"Thách thức thời gian",		"Chuỗi nhiệm vụ Dã Tẩu" }	--周目标类型名称
...
TASKID_HEROLING_COUNT		=	2499			--累积的英雄令个数（可+可-Êâ
...
TB_TONG_FIGURE_NAME =
{
	[TONG_MASTER]	=	"Bang chủ ",
	[TONG_ELDER]	=	"Trưởng Lão",
	[TONG_MANAGER]	=	"Đội trưởng",
	[TONG_MASS]		=	"Đệ tử ",
	[TONG_RETIRE]	=	"ẩn sỹ",
};
...
-- 特技相关
TB_STUNT_RIGHT_DS	=	{ "Cấp lãnh đạo", "Tất cả thành viên" }
