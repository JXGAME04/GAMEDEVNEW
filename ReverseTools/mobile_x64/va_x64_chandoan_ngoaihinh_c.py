...
ok_log = (b"#ifndef _SERVER" + nl +
          ind_in + b"if (Npc[nNpcIdx].m_Kind == kind_player && Npc[nNpcIdx].m_nPlayerIdx > 0)\t// " + TAG + nl +
...
fail_log = (ind_out + b"else" + nl +
            ind_out + b"{" + nl +
            b"#ifndef _SERVER" + nl +
            ind_in + b"if (Npc[nNpcIdx].m_Kind == kind_player && Npc[nNpcIdx].m_nPlayerIdx > 0)\t// " + TAG + b" that bai -> m_bChange ket, khong SetCurFrame" + nl +
