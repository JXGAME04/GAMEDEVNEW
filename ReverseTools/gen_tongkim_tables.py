...
w("// (26/08 v2) LUI XUONG y=3085: diem (1566,3084) do bang Bresenham thi sach, nhung")
w("// bo lay mau CUA ENGINE (TK_ThayDuoc: nB = max(|dx|,|dy|)/32, diem ax+dx*i/nB) lai")
w("// di duong khac va cham 2 o tuong (1560,3082)+(1559,3082). Diem chon lai bang CHINH")
w("// bo lay mau do - xem ReverseTools/tk_pick_vongkim.py.")
w("static const TKPoint g_TKVongKim   = { 1566, 3085 };")
