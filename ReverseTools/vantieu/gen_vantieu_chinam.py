...
S["VT_BH_LUUY"] = ("Tại Tiếp Dẫn còn có Xem thông tin Tiêu Xa, Truyền tống đến Tiêu Xa (chờ 20 giây, tăng dần tới 60) và Từ bỏ. "
                   "Người đang giữ xe không rời bang hoặc bị khai trừ được; bang đã mở áp tiêu trong tuần thì không đổi bang chủ.")
