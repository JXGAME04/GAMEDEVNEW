...
Cac chuoi TCVN3 duoc LAY NGUYEN BYTE tu lang.lua / magicscript.txt cua ban Linux
(khong go tay, khong tu sinh lai) de bao dam trung khop 100%.
"""
import os

OUT = r'D:\GAMEDEVNEW_wt_vantieu\serverscript_jx2\vantieu\moi\script\event\longmenbiaoju\lmbj_config.lua'

# TCVN3 - nguon:
#   7 dong dau: ...\vantieu\lua54\script\event\longmenbiaoju\lang.lua:6-12
#   LiBao     : D:\ServerLinux\server1\settings\item\004\magicscript.txt:4863
N = {
    'BiaoQi':        b'Ti\xaau K\xfa',
    'PingZheng':     b'Ho\xb8n Ti\xaau Ch\xd8',
    'WeiRenZhuang':  b'\xb8p ti\xaau \xf1y nhi\xd6m tr\xb9ng cao c\xcap',
    'HuBiaoLing':    b'H\xe9 Ti\xaau L\xd6nh',
    'KuaiMaJiaBian': b'Kho\xb8i M\xb7 Gia Ti\xaan',
    'JianBuKeCui':   b'Ki\xaan B\xcat Kh\xb6 T\xe1a',
    'BiaoCheWeiYi':  b'Ti\xaau Xa Di V\xde',
    'LiBao':         b'L\xd4 Bao Ti\xaau C\xf4c',
}


def s(k):
    return N[k].decode('latin-1')
