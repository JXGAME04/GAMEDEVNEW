...
ScriptProtocol.KE_SCRIPT_PROTOCOL = 
{
	...
	"emSCRIPT_PROTOCOL_C2S_MONTHLYRECHARGE_GETLOTTERYSCROLL",
	"emSCRIPT_PROTOCOL_C2S_MONTHLYRECHARGE_GETLOTTERYDATA",
	"emSCRIPT_PROTOCOL_C2S_MONTHLYRECHARGE_GETLOTTERYAWARD",
	"emSCRIPT_PROTOCOL_S2C_MONTHLYRECHARGE_SETLOTTERYDATA",
	---------------------月充值活动 End--------------------------
	"emSCRIPT_PROTOCOL_S2C_CLOSEWINDSINGAME",	--关闭界面
	-------------------决战巅峰----------------------------------
	...
	---------------------英雄塔Ui End------------------------------------------
	"emSCRIPT_PROTOCOL_C2S_WLL_GET_DAILY_AWARD",
	"emSCRIPT_PROTOCOL_S2C_WLL_SYNC_INFO",
	"emSCRIPT_PROTOCOL_C2S_WLL_LEVELUP_TASK_REQ",
