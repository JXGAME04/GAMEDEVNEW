...
--      },
    ...
    [tbFacDef.tbIds.XIAOYAO] = {-- åÐÒ£ÅÉ
        ...
        tbSkillID       =
        {
            ...
            [90] = {
                {2124, 1, "Tiªu Dao KiÕm T«ng", "KiÕm QuyÕt Phï V©n"},  -- ½£¾ö¸¡ÔÆ(90¼¶)
                {2141, 1, "Tiªu Dao CÇm T«ng", "Cao S¬n L­u Thñy "},  -- ¸ßÉ½Á÷Ë®(90¼¶)
            },
            [120] = {
                {2127, 1, "Th«ng dông", "¡n Uèng No Say"}                   -- à¢ÖË³Öõü(120¼¶)
            },
            [150] = {
                {2129, 1, "Tiªu Dao KiÕm T«ng", "ThËp Bé NhÊt S¸t"},  -- Ê®²½Ò»É±
                {2142, 1, "Tiªu Dao CÇm T«ng", "Mai Hoa Tam Léng"},  -- Ã·»¨ÈýÅª
            },
        },
        tbItemInfo      =
        {
