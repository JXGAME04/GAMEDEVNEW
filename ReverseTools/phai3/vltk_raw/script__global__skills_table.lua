...
function add_wh(lvl)			-- ¸ù¾İÈÎÎñµÈ¼¶¼ÓÏàÓ¦µÄÎä»ê¼¼ÄÜ
	...
	for nNeedLevel, tbSkillList in tbSkills do
		-- ¸øÓèËùÓĞ´«ÈëµÈ¼¶ÒÔÏÂµÄËùÓĞ¼¼ÄÜ£¬µ«ÊÇÂß¼­ÉÏ£¬´Ë´¦Ó¦¸ÃÖ»ÄÜ¸øÓè70¼¶ÒÔÏÂµÄ¼¼ÄÜ£¬ÒÔ·ÀÍòÒ»ÔÚÕâÀï×öÁËÒ»²ãÏŞÖÆ
...
function add_xy(lvl)			-- ¸ù¾İÈÎÎñµÈ¼¶¼ÓÏàÓ¦µÄÎä»ê¼¼ÄÜ
