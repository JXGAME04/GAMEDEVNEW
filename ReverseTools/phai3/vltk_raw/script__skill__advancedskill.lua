...
--		},
	...
	em_adskill ={ --¶ëÃ¼½ø½×¼¼ÄÜ
		skill_desc=
			function(level)
				return "Tróng môc tiªu cã<color=orange>"..floor(Link(level,SKILLS.em_adskill.autoattackskill[3]) - 3*18*256).."%<color> tØ lÖ thi triÓn cÊp t­¬ng øng <color=water> [Tõ Hµng Phæ §é cao cÊp]<color>\n"..
