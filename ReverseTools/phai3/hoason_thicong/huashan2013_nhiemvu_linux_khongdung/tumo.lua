...
elseif (GetTask(169) == 26) and (HaveCommonItem(6,1,4948)>0) and (HaveCommonItem(6,1,4949)>0) and (HaveCommonItem(6,1,4950)>0) then
...
tbAwardTemplet:GiveAwardByList({tbProp = {6,1,4947,0,0,0}, nBindState=-2}, "test", 1);
	SetTask(169,21)
...
function L20_hs2() 
DelCommonItem(6,1,4948)
DelCommonItem(6,1,4949)
DelCommonItem(6,1,4950)
SetRank(84)
SetTask(169,30)
