...
elseif (GetTask(169) == 12) and (HaveCommonItem(6,1,4946)>0) then
...
tbAwardTemplet:GiveAwardByList({tbProp = {6,1,4944,1,0,0}, nBindState=-2}, "test", 1);
...
function L10_get_yes()  
	tbAwardTemplet:GiveAwardByList({tbProp = {6,1,4945,0,0,0}, nBindState=-2}, "test", 1);
	SetTask(169,11)
