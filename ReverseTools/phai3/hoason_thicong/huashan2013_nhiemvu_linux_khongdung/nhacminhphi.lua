...
elseif (GetTask(69) == 22) and (HaveCommonItem(6,1,4961)>0) then 
...
AddMagic(1382,1)
AddMagic(1365,1)
AddItem(6,1,4963,0,0,0)
AddItem(6,1,4964,0,0,0)
...
function L902_hs() 
tbAwardTemplet:GiveAwardByList({tbProp = {6,1,4962,0,0,0}, nBindState=-2}, "test", 1);
DelCommonItem(6,1,4961)
SetTask(69,23)
