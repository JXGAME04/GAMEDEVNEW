...
-- [HOASON 01/09] bo (JX1 khong co, xem hs_shim.lua): Include("\\script\\misc\\daiyitoushi\\toushi_function.lua")
...
elseif (GetTask(169) > 68) and (GetTask(169) <70) and (HaveCommonItem(6,1,4955) == 1)then
Talk(1,"","Nam Cung TuyÖt: Mau ®i ®i.")
...
elseif (GetTask(169) == 69) and (HaveCommonItem(6,1,4955) == 0) then
...
function L50222_hs() 
 tbAwardTemplet:GiveAwardByList({tbProp = {6,1,4955,0,0,0}, nBindState=-2}, "test", 1);
end
