...
#include "Text.h"
#include "../UiCase/UiChatItem.h"// chat item
...
void KWndPureTextBtn::SetColor(unsigned int uNormal, unsigned int uNormalBorder, unsigned int uOver, unsigned int uOverBorder, unsigned int uSel, unsigned int uSelBorder)// chat item //dinh mau chu~
{
