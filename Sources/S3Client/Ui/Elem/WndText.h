...
public:
	...
	void			SetCoinText(int nNumber, char Separator = 0);
	void			Set2IntText(int nNumber1, int nNumber2, char Separator);
	void			Set2DoubleText(double nNumber1, double nNumber2, char Separator);
	void			SetFindIntText(int nNumber1, int nNumber2, char Separator, char Find);
	...
	void SetHAlign(unsigned int nType) //add by phong ki襲 t鑞g kim battle
	{
		m_Style |= nType;		
	};
	void			SetMoneyUnitPrice(int nPrice, int nMoneyUnit);
	void			SetMoneyUnitText(int nMoneyUnit);
	void			SetTimeText(int nNumber); 	
	void			SetTimeText2(int nNumber); 
protected:
