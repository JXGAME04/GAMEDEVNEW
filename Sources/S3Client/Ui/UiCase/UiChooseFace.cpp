...
void KUiChooseFace::PaintWindow()
{
	...
	if (g_pRepresentShell)
	{
		...
		if (nCheck > 0)
		{
			...
			{
			case 1:
				m_OneFemaleBtn.GetPosition(&nX, &nY);
				break;
			case 2:
				m_TwoFemaleBtn.GetPosition(&nX, &nY);
				break;
			case 3:
				m_ThreeFemaleBtn.GetPosition(&nX, &nY);
				break;
			case 4:
				m_FourFemaleBtn.GetPosition(&nX, &nY);
				break;
			case 5:
				m_FiveFemaleBtn.GetPosition(&nX, &nY);
				break;
			case 6:
				m_SixFemaleBtn.GetPosition(&nX, &nY);
				break;
			case 7:
				m_SevenFemaleBtn.GetPosition(&nX, &nY);
				break;
			case 8:
				m_EightFemaleBtn.GetPosition(&nX, &nY);
				break;
			case 9:
				m_NineFemaleBtn.GetPosition(&nX, &nY);
				break;
			case 10:
				m_TenFemaleBtn.GetPosition(&nX, &nY);
				break;
			case 11:
				m_ElevenFemaleBtn.GetPosition(&nX, &nY);
				break;
			case 12:
				m_TwelveFemaleBtn.GetPosition(&nX, &nY);
				break;
			case 13:
				m_OneMaleBtn.GetPosition(&nX, &nY);
				break;
			case 14:
				m_TwoMaleBtn.GetPosition(&nX, &nY);
				break;
			case 15:
				m_ThreeMaleBtn.GetPosition(&nX, &nY);
				break;
			case 16:
				m_FourMaleBtn.GetPosition(&nX, &nY);
				break;
			case 17:
				m_FiveMaleBtn.GetPosition(&nX, &nY);
				break;
			case 18:
				m_SixMaleBtn.GetPosition(&nX, &nY);
				break;
			case 19:
				m_SevenMaleBtn.GetPosition(&nX, &nY);
				break;
			case 20:
				m_EightMaleBtn.GetPosition(&nX, &nY);
				break;
			case 21:
				m_NineMaleBtn.GetPosition(&nX, &nY);
				break;
			case 22:
				m_TenMaleBtn.GetPosition(&nX, &nY);
				break;
			case 23:
				m_ElevenMaleBtn.GetPosition(&nX, &nY);
				break;
			case 24:
				m_TwelveMaleBtn.GetPosition(&nX, &nY);
				break;
			case 25:
				m_ThirteenMaleBtn.GetPosition(&nX, &nY);
				break;
			case 26:
				m_FourteenMaleBtn.GetPosition(&nX, &nY);
				break;
			case 27:
				m_FifteenMaleBtn.GetPosition(&nX, &nY);
				break;
			default:
				break;
			}
			...
			KRURect	rect70;
			rect70.Color.Color_dw = 0xFF000000 | 242 << 16 | 255 << 8 | 242;
			rect70.oPosition.nX = Shadow.oPosition.nX + nX;
			rect70.oPosition.nY = Shadow.oPosition.nY + nY;
			rect70.oEndPos.nZ = rect70.oPosition.nZ = 0;
			rect70.oEndPos.nX = rect70.oPosition.nX + 71;
			rect70.oEndPos.nY = rect70.oPosition.nY + 71;
			g_pRepresentShell->DrawPrimitives(1, &rect70, RU_T_RECT, true);
			...
			else if (nCheck == 25) // ¶nh n÷ chØ cã 12 h×nh
			{
				KRURect	rect13;
