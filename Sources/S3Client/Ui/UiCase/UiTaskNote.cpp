...
#define 	SCHEME_INI_TASKNOTE			"UiTaskNote1.ini"
#define 	SCHEME_INI_SYSTEM			"UiTaskNote2.ini"
#define 	SCHEME_INI_PERSONAL			"UiTaskNote3.ini"
...
void KUiTaskNote_System::UpdateView()
{
	...
	if (nCount > 0)
	{
		m_RecordList.GetMessageListBox()->SetCapability(nCount);	
