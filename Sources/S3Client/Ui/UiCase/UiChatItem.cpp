...
//Author: Fong Ki襲
//Date: 2021
//Function:Cua so item kenh chat
// -------------------------------------------------------------------------
#include "KWin32.h"
#include "KIniFile.h"
...
#define	SCHEME_INI 	"UiChatItemInfo.ini"
...
void KUiChatItem::PaintWindow()
{
	...
	for (int i = 0; i < m_BorderPieces ; i++)
	{
		...
		strcpy(Border[i].szImage, "\\Spr\\Ui\\物品装备说明菜单\\物品装备说明菜单边条3.spr");
		Border[i].nFrame = 0;
	...
	for (int j = m_BorderPieces; j < m_BorderPieces*2 ; j++)
	{
		...
		strcpy(Border[j].szImage, "\\Spr\\Ui\\物品装备说明菜单\\物品装备说明菜单边条3.spr");
		Border[j].nFrame = 0;
