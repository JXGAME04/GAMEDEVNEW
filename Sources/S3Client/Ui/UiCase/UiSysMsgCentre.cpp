...
#include "UiTrembleItem.h" //kh¶m n¹m
...
#define MSG_ASKASSEMBLE		"B¹n x¸c ®Þnh muèn kh¶m ­?"
#define MSG_AGREE_ASKASSEMBLE		"X¸c nhËn" 
#define MSG_DEGREE_ASKASSEMBLE		"Hñy bá"
...
bool KUiSysMsgCentre::AMessageArrival(KSystemMessage* pMsg, void* pParam)
{
	...
	if (pMsg->byConfirmType == SMCT_UI_ASKASSEMBLE)	// Thong bao xac nhan kham
	{
		UIMessageBox(MSG_ASKASSEMBLE, m_pSelf, MSG_AGREE_ASKASSEMBLE, MSG_DEGREE_ASKASSEMBLE, SMCT_UI_ASKASSEMBLE);
		return true;
	}
