...
void KUiCompoundOne::LoadScheme( const char* pScheme )
{
	...
	if (Ini.Load(Buff))
	{
		...
		m_Pos2.SetText("D©y chuy“n/HÈ phÔ");
		...
		m_Pos3.SetText("Ng‰c bÈi/H≠¨ng nang");
