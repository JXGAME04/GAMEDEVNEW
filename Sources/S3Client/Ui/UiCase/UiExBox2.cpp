...
#define SCHEME_INI_ITEM	"UiExBox2.ini"
...
void KUiExBox2::UpdateData()
{
	...
	{
		g_pCoreShell->GetGameData(GDI_ITEM_IN_EX_BOX2, (KUPARAM)pObjs, nCount);//µ•œﬂ≥Ã÷¥––£¨nCount÷µ≤ª±‰
...
// π¶ƒ‹	: ¥∞ø⁄∫Ø ˝
// -------------------------------------------------------------------------
int KUiExBox2::WndProc(unsigned int uMsg, KUPARAM uParam, KNPARAM nParam)
{
	switch(uMsg)
	{
