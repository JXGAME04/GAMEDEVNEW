...
#define VT_CN_DK             "§iÒu kiÖn: cÊp 120 trë lªn (hoÆc ®· chuyÓn sinh) vµ ®· gia nhËp m«n ph¸i. Giê më: 10:00 ®Õn 23:00 h»ng ngµy. Mçi ngµy nhËn tèi ®a 3 nhiÖm vô; lµm míi nhiÖm vô ngÉu nhiªn miÔn phİ 5 lÇn, hÕt l­ît th× dïng Ho¸n Tiªu ChØ."
...
#define VT_CN_B3B            "Xe cã m¸u vµ bŞ ng­êi kh¸c ®¸nh ph¸. Xe vì th× r¬i <color=yellow>Tiªu Kú <color> (chØ chñ xe nhÆt ®­îc, cßn 10 phót) vµ <color=yellow>T¸n L¹c Tiªu VËt<color> (3 phót ®Çu chØ chñ xe vµ tæ ®éi nhÆt, sau ®ã ai ®ñ cÊp 150 còng nhÆt ®­îc, mçi ng­êi 5 lÇn mét ngµy). Mang Tiªu Kú vÒ Tiªu S­ vÉn nhËn mét phÇn th­ëng; mÊt c¶ xe lÉn kú th× chän KÕt thóc nhiÖm vô ®Ó nhËn 100 v¹n kinh nghiÖm."
...
#define VT_CN_HINT           "<color=Cyan>NhÊp vµo dßng nhiÖm vô ®Ó tù ®i: ch­a nhËn th× tíi ¤ng chñ Tiªu côc ë Long M«n trÊn (thuª xe nÕu kh¸c b¶n ®å); ®· nhËn th× tíi Tiªu S­ ®iÓm ®Çu; xe ®· xuÊt ph¸t th× tíi Tiªu S­ ®iÓm cuèi nÕu cïng b¶n ®å.<color>"
...
#define VT_BH_HINT           "<color=Cyan>NhÊp vµo dßng nhiÖm vô ®Ó tù ®i tíi TiÕp DÉn ¸p Tiªu Bang (dïng phï vÒ thµnh nÕu ®ang ë ngoµi thµnh); ®ang gi÷ xe th× ®i tíi NhËn Hµng ®iÓm cuèi nÕu cïng b¶n ®å.<color>"
