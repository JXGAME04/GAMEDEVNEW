...
#define VT_CN_B3             "B­íc 3 - Hé tèng: ®i bé (c­ìi ngùa ®­îc) dÉn Tiªu Xa tíi Tiªu S­ ë ®iÓm cuèi tr­íc khi hÕt 30 phót. Xe b¸m theo khi ng­¬i ë gÇn (d­íi 16 «); trong cïng b¶n ®å mµ ng­¬i ®i xa h¬n (kÓ c¶ dïng phï) th× xe ®øng l¹i ®îi, qu¸ 5 phót kh«ng ai quay l¹i th× xe biÕn mÊt. Ng­¬i sang b¶n ®å kh¸c b»ng bÊt cø c¸ch nµo (cöa b¶n ®å, phï vÒ thµnh, Xa Phu) th× xe ®­îc kĞo sang theo ngay. Tho¸t game th× xe ®øng ®îi 5 phót: vµo l¹i kŞp th× xe theo tiÕp, qu¸ 5 phót lµ mÊt xe."
...
#define VT_BH_LUUY           "T¹i TiÕp DÉn cßn cã Xem th«ng tin Tiªu Xa, TruyÒn tèng ®Õn Tiªu Xa (chê 20 gi©y, t¨ng dÇn tíi 60) vµ Tõ bá (chØ trong giê 12:00 ®Õn 23:00)."
