...
#define SCHEME_INI_ITEM	"UiExBoxMain.ini"
#define SCHEME_INI_EX1	"UiExBox1.ini"
...
void KUiExBox1::UpdateData()
{
	...
	{
		g_pCoreShell->GetGameData(GDI_ITEM_IN_EX_BOX1, (KUPARAM)pObjs, nCount);//µ•œﬂ≥Ã÷¥––£¨nCount÷µ≤ª±‰
