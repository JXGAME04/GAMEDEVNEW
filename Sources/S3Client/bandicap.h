...
#ifdef _WIN64
	#ifdef _DEBUG
	#	define BANDICAP_DLL_FILE_NAME			_T("jxreplay64.dll")
	#else
	#	define BANDICAP_DLL_FILE_NAME			_T("jxreplay64.dll")
	#endif
	#define BANDICAP_RELEASE_DLL_FILE_NAME		_T("jxreplay64.dll")
#else
	#ifdef _DEBUG
	#	define BANDICAP_DLL_FILE_NAME			_T("jxreplay32.dll")
	#else
	#	define BANDICAP_DLL_FILE_NAME			_T("jxreplay32.dll")
	#endif
	#define BANDICAP_RELEASE_DLL_FILE_NAME		_T("jxreplay32.dll")
#endif
...
public :
	...
	HRESULT Create(LPCTSTR szDllPathName)
	{
		...
		m_hDll = LoadLibrary("bdcap32.dll");
		if(m_hDll==NULL)
		{
