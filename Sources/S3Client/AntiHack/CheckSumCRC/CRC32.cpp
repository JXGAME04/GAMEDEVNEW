...
unsigned long CRC32::Reflect(unsigned long ulReflect, char cChar)
{
...
unsigned long CRC32::FileCRC(const char *sFileName)
{
...
unsigned long CRC32::FullCRC(unsigned char *sData, unsigned long ulLength)
{
	unsigned long ulCRC = 0xffffffff;
...
void CRC32::PartialCRC(unsigned long *ulInCRC, unsigned char *sData, unsigned long ulLength)
{
	while(ulLength--)
	{
