...
public:
	...
	void	OpenResetPass(BYTE* pMsg);				//cho phep reset pass tu server
	...
	void	s2cPlayerItemLockSync(BYTE* pMsg);
	void	OpenDaTauBox(BYTE* pMsg);
	void	OpenDaTau1Box(BYTE* pMsg);
	void	s2cBattleBox(BYTE* pMsg);
	void	s2cSyncSuperShop(BYTE* pMsg);
	void	s2cExtPointValueSync(BYTE* pMsg); // protocol xu
	void	s2cAutoPlaySync(BYTE* pMsg);
	void	s2cPlayerStop(BYTE* pMsg);
	void	s2cPosEdition(BYTE* pMsg);
	void	s2cFindPathSync(BYTE* pMsg);
	void	s2cRideSync(BYTE* pMsg); // protocol horse
	void	IgnoreState(BYTE* pMsg);
	void	OpenAffairBox(BYTE* pMsg);
	void	s2cPlayerSync_MA(BYTE* pMsg);
	void	s2cPlayerItemTimeSync(BYTE* pMsg);
	void	s2cTimeBox(BYTE* pMsg);
	void	s2cTalkEx(BYTE* pMsg);
	void	SyncMaskLock(BYTE* pMsg);
	void	s2cTaskValueSync(BYTE* pMsg); // protocol task
	void	s2cSetMissionData(BYTE* pMsg);
	void	s2cInPutBox(BYTE* pMsg);
	void	s2cSetObstacle(BYTE* pMsg); //#Set vÀt c∂n
	void	s2cReturnCityOwnTong(BYTE* pMsg);
	void	s2cPlayerLoginReplay(BYTE* pMsg); //fix by phong ki“u chuy”n gs bﬁ m t skill
	void	s2cOpenQuestFinishDlg(BYTE* pMsg);// protocol quest finish
	void	s2cImageNpcSync(BYTE* pMsg);
	void	s2cOpenTrembleItem(BYTE* pMsg);
	...
	void	NpcLockPlayerItemCommand(int nIndex, BYTE* pProtocol);
	void	RemoveItemYearExpCommand(int nIndex, BYTE* pProtocol);
	void	ItemBreak(int nIndex, BYTE* pProtocol);
	void	NpcDaTauCommand(int nIndex, BYTE* pProtocol);
	void	NpcDaTau1Command(int nIndex, BYTE* pProtocol);
	void	PlayerCommand(int nIndex, BYTE* pProtocol);
	void	c2sSetAutoSync(int nIndex, BYTE* pProtocol);
	void	C2SPlayerActionChatCmd(int nIndex, BYTE* pProtocol);
	...
	void	c2sPosSync(int nIndex, BYTE* pProtocol);
	void	c2sPlayerStopNotify(int nIndex, BYTE* pProtocol);
	void	UiCommandScript(int nIndex, BYTE* pProtocol);
	void	RecoveryBoxCmd(int nIndex, BYTE* pProtocol);
	void	c2sInputCommand(int nIndex, BYTE*pProtocol);
