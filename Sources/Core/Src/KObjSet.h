...
public:
	...
	int			m_nShowNameFlag;		// item money object
#endif
private:
	KLinkArray	m_UseIdx;
...
public:
	...
	int		Add_backup(int nDataID, KMapPos MapPos, KObjItemInfo sItemInfo);
	...
	int		AutoGetObjNear(int nX1, int nY1, int nDistance, int nPickOption = 0, BOOL bPickMoney = FALSE);//fkauto
#endif
	int		FindID(int nID);
