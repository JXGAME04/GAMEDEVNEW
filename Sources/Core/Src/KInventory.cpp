...
int	KInventory::FindNumberArrayItem(int nIdx)//add by phong ki“u antihack
{
	if (!m_pArray)
		return 0;
...
BOOL  KInventory::FindSameItemToSort(int nIdx, int *pnIdx, int *pnX, int *pnY)//#xu ly xep chong xˆ l˝ x’p chÂng
{
	if (!m_pArray)
		return FALSE;
