...
enum MAGIC_ATTRIB
{
	...
	magic_durability_v,						//31		//#kh«ng thÓ ph¸ huû
	magic_requirestr,						//32
	magic_requiredex,						//33
	magic_requirevit,						//34
	magic_requireeng,						//35
	...
	magic_indestructible_b,					//43	//#kh«ng thÓ ph¸ huû
	magic_married,							//44
	...
	magic_seriesdamage_p,					//60		//ngò hµnh t­¬ng kh¾c
	...
	magic_deadlystrike_p,					//71	//tÊn c«ng chÝ m¹ng
	magic_fatallystrike_p,					//72	//tÊn c«ng chÝ tö
	magic_stun_p,							//73
	...
	magic_fasthitrecover_v,					//113		//thêi gian phôc håi
	magic_allres_p,							//114
	...
	magic_addphysicsdamage_p,				//126		//S¸t th­¬ng vËt lý ngo¹i %
	...
	magic_fatallystrikeenhance_p,			//152	//thªm tÊn c«ng chÝ tö
	...
	magic_coldenhance_p,					//161 //thêi gian tr× ho·n
	...
	magic_fasthitrecover_yan_v,				//245		//thêi gian phôc håi
	magic_five_elements_enhance_v,			//246	//Ngò Hµnh C­êng Ho¸
	magic_five_elements_resist_v,			//247		//Ngò Hµnh Nh­îc Ho¸
