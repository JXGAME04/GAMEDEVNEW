...
int  AUC_KenhBangID(unsigned long dwTong);	// [BH100] id kenh chat bang da hoc (-1 neu chua)
int  AUC_MsgTongC(unsigned long dwTong, const char* szMsg);	// [BH100] dong 'Tin bang' toi moi thanh vien online (C++ goi)	// KNewProtocolProcess::P_ProcessPlayerCommExtend goi (chi doc goi tin)
