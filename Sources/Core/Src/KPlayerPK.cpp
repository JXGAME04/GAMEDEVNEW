...
//-------------------------------------------------------------------------
void	KPlayerPK::SetNormalPKState(BYTE bFlag, BOOL bLock)
{
...
BOOL KPlayerPK::GetLockPKState()
{
	return this->m_bLockPK;
}
//-------------------------------------------------------------------------
//	功能：关闭仇杀PK
//-------------------------------------------------------------------------
...
//	功能：设定正常PK状态 TRUE 打开，可以砍人  FALSE 关闭，不可以砍人
//-------------------------------------------------------------------------
void	KPlayerPK::SetNormalPKState(BYTE bFlag, BOOL bLock, BOOL bShowMsg/* = TRUE*/)
{
	m_bLockPK = bLock;
...
//-------------------------------------------------------------------------
void	KPlayerPK::ApplySetNormalPKState(BYTE bFlag, BOOL bLock)
{
