...
enum GAMEDATA_INDEX
{
	...
	SGDI_TONG_CHANGE_TITLE_POWER,
	
	SGDI_TONG_GET_TITLE_POWER,
	
	SGDI_TONG_CHANGE_SEX_TITLE_POWER,
	
	SGDI_TONG_BE_CHANGED_TITLE,
	...
	SGDI_TONG_APPLY_CHANGE_RECRUIT,

	SGDI_TONG_BE_CHANGED_RECRUIT,
	
	SGDI_STOP_GAMESERVER,

	SGDI_TONG_APPLY_CHANGE_LEVEL,
...
#endif
{
	...
	virtual void RemovePlayerForLimit(int nIndex) = 0;
...
iCoreServerShell* CoreGetServerShell(const char* gamepass="kjgljdsflgjasldfkjlkasdf");
