...
void	KLittleMap::Init(int nLeft, int nTop, int nRight, int nBottom)
{
	...
	// for auto pathing
	//int		i, j;
	//for (i = m_sMapRect.left; i < m_sMapRect.right; i++)
	//{
	//	for (j = m_sMapRect.bottom; j <= m_sMapRect.top; j++)
	//	{
...
//---------------------------------------------------------------------------
//	Function: Get the storage address of the barrier data of a region
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
//	Function: Set the obstacle data that has been loaded into a region
//---------------------------------------------------------------------------
...
BYTE** KLittleMap::GetBarrierBuf()
{
	return m_ppbtBarrier;
}
