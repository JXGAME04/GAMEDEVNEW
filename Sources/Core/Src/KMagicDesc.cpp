...
const char MAGIC_ATTRIB_STRING[][100] = 
{
	...
	"armordefense_v",					//30 
	"durability_v",						//31  //#kh«ng thÓ ph¸ huû
	"requirestr",						//32 
	"requiredex",						//33 
	"requirevit",						//34 
	"requireeng",						//35 
	...
	"indestructible_b",					//43  //#kh«ng thÓ ph¸ huû
	"married",							//44 
	"dec_percasttime",					//45 
	...
	"ignoredefense_p",					//58 
	"magicdamage_v",					//59 
	"seriesdamage_p",					//60		//ngò hµnh t­¬ng kh¾c
	"physicsdamage_v",					//61 
	"colddamage_v",						//62 
	"firedamage_v",						//63 
	"lightingdamage_v",					//64 
	...
	"stealstamina_p",					//69 
	"knockback_p",						//70 
	"deadlystrike_p",					//71  //tÊn c«ng chÝ m¹ng
	"fatallystrike_p",					//72	//tÊn c«ng chÝ tö
	"stun_p",							//73 
	"trong",							//74 
	"randmove",							//75 
	"damage_reserve2",					//76 
	...
	"fastwalkrun_p",					//111
	"visionradius_p",					//112
	"fasthitrecover_v",					//113		//thêi gian phôc håi
	"allres_p",							//114
	"attackspeed_v",					//115
	"castspeed_v",						//116
	...
	"addphysicsdamage_p",				//126		//S¸t th­¬ng vËt lý ngo¹i %
	"slowmissle_b",						//127
	"changecamp_b",						//128
	"physicsarmor_v",					//129
	"coldarmor_v",						//130
	...
	"adddefense_v",						//150
	"adddefense_p",						//151
	"fatallystrikeenhance_p",			//152	//thªm tÊn c«ng chÝ tö
	"lifepotion_v",						//153
	"manapotion_v",						//154
	"physicsresmax_p",					//155
	"coldresmax_p",						//156
	...
	"poisonresmax_p",					//159
	"allresmax_p",						//160
	"coldenhance_p",					//161 //thêi gian tr× ho·n
	"fireenhance_p",					//162
	...
	"fasthitrecover_yan_v",				//245		//thêi gian phôc håi
	"five_elements_enhance_v",			//246	//Ngò Hµnh C­êng Ho¸
	"five_elements_resist_v",			//247		//Ngò Hµnh Nh­îc Ho¸
	...
	while(*pTempDesc)
	{
		if (*pTempDesc == '#')
		{
			...
			case 't':
					...
					itoa(nValue,cbBuffer,10);
					pTab.Load(PLAYER_RANK_BATTLE_SETTING_TABFILE);
					pTab.GetString(cbBuffer, "TitleName",	"", Buff, sizeof(Buff));
					strcat(m_szDesc,Buff);
					i += strlen(Buff);
				break;	
			default:
				break;
