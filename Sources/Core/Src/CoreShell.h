...
enum AUTOOPERATION_INDEX
{
	...
	ATYPE_ACCHINH,		// (03/09) may Ac chinh: gui vi tri len WAuto + ac phu di theo / danh cung muc tieu (AC_Process)
};
...
//	GOI_DROP_ITEM,				//放置物品到游戏窗口
	...
	// [PF13 01/09] panel Tay Luyen: uParam = dwID phi phong, nParam = (char*) dem
