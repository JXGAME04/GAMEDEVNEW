	...
	case RU_T_RECT:
		{
			...
			for (i = 0; i < nPrimitiveCount; i++, pTemp++)
			{
				...
				int nColor = pTemp->Color.Color_dw & 0xffffff;
				m_Canvas.DrawLineAlpha(nX1, nY1, nX2, nY1, nColor, pTemp->Color.Color_b.a);	//é?±?
				m_Canvas.DrawLineAlpha(nX1, nY2, nX2, nY2, nColor, pTemp->Color.Color_b.a);	//??±?
				m_Canvas.DrawLineAlpha(nX1, nY1, nX1, nY2, nColor, pTemp->Color.Color_b.a);	//×ó±?
				m_Canvas.DrawLineAlpha(nX2, nY1, nX2, nY2, nColor, pTemp->Color.Color_b.a);	//óò±?
			}
		}
		break;
	case RU_T_SHADOW:
