...
extern int g_nJxDoVeChiTiet;	// [VECHITIET 11/09] [Client] Rep3DoVeChiTiet: do tong thoi gian nam TRONG lop ve moi khung (tach khoi viec dung canh cua game)
extern double g_dJxTrongVeKhung, g_dJxTrongVeCuoi;	// [VECHITIET 11/09] cong don trong khung dang ve / gia tri cua khung vua xong (ms)
extern unsigned g_uJxTrongVeLan;	// [VECHITIET 11/09] so lan goi DrawInternal trong khung vua xong
