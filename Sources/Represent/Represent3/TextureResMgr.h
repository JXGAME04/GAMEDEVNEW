...
struct ResNode
{
	ResNode() : m_bDangNap(false), m_nLanHong(0), m_bNapTruoc(false) {}	// [NAP 08/09 b/e] [NAPCHIEU 09/09 b]
	...
	bool		m_bNapTruoc;				// [NAPCHIEU 09/09 b] muc do NapTruoc chen, chua duoc hoi lan nao (lan hoi dau: kip/tre)
...
public:
	...
	unsigned m_nNapTruocKip, m_nNapTruocTre;	// [NAPCHIEU 09/09 b] lan hoi dau cua muc nap truoc: da nap xong / con dang nap
