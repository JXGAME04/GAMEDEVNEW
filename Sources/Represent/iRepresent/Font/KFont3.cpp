...
// FileDescription	:	字体类
// Revision Count	:	
//Huong dan C:\JX\swrod3\SwordOnline\Sources\Represent\iRepresent\Font copy P2 P3 va build lai chep vao client
*******************************************************************************/
#include "KFont3.h"
#include "string.h"
					...
					unsigned int nColor /*=0xff000000*/, int nLineWidth/*= 0*/)
{
	...
	while (nPos < nCount)
	{
		...
		//********* hien thi ngon ngu tieng viet 3D edit by phong kieu 字符的判断与处理*********
