...
public:
	...
	enum enumTask
	{
		...
		enumRemoveAccountLixian,//#uy thac
	};
	...
	static IGServer *QueryServer( UINT nMapID, unsigned int nSerNoIndex = 1);
...
protected:
	...
	bool _RemoveAccountLixian(const void *pData, size_t datalength);	//#uy thac	
