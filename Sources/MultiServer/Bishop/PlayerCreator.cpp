...
const TRoleData* CPlayerCreator::GetRoleData(unsigned int &uDataLength, LPROLEPARAM lpParam)
{
	...
	if (m_pRoleData[nIndex])
	{
		...
		if(lpParam->nMapID == 0) // fix by tuan ln
		{
			int nMapDefault = 53;
			nNativeID = GetRevivalID( nMapDefault ); 
			pData->BaseInfo.irevivalid = nMapDefault;
		}
...
bool CPlayerCreator::GetRoleDataFromIni(BYTE* pData, const char* szFileName)
{
	...
	//remark by spe because client ui display changed 2003/07/21
	...
	pRoleData->BaseInfo.ipassrole = 123456;

	pRoleData->BaseInfo.skilltrain1 = 0;
	pRoleData->BaseInfo.skilltrain2 = 0;
	pRoleData->BaseInfo.skilltrain3 = 0;
	pRoleData->BaseInfo.skilltrain4 = 0;
	pRoleData->BaseInfo.skilltrain5 = 0;
	pRoleData->BaseInfo.skilltrain6 = 0;
	pRoleData->BaseInfo.skilltrain7 = 0;
	pRoleData->BaseInfo.skilltrain8 = 0;
	pRoleData->BaseInfo.skilltrain9 = 0;

	pRoleData->BaseInfo.ipduphong1 = 0; //#avatar player
	pRoleData->BaseInfo.ipduphong2 = 0; //#PKState
	pRoleData->BaseInfo.ipduphong3 = 0;
	pRoleData->BaseInfo.ipduphong4 = 0;
	pRoleData->BaseInfo.ipduphong5 = 0;
	pRoleData->BaseInfo.ipduphong6 = 0;
	pRoleData->BaseInfo.ipduphong7 = 0;
	pRoleData->BaseInfo.ipduphong8 = 0;
	pRoleData->BaseInfo.ipduphong9 = 0;
	
	pRoleData->BaseInfo.szStringduphong1[0] = 0;//#MateName
	pRoleData->BaseInfo.szStringduphong2[0] = 0;
	pRoleData->BaseInfo.szStringduphong3[0] = 0;
	pRoleData->BaseInfo.szStringduphong4[0] = 0;
	pRoleData->BaseInfo.szStringduphong5[0] = 0;
	pRoleData->BaseInfo.szStringduphong6[0] = 0;
	pRoleData->BaseInfo.szStringduphong7[0] = 0;
	pRoleData->BaseInfo.szStringduphong8[0] = 0;
	pRoleData->BaseInfo.szStringduphong9[0] = 0;
...
//Item
	...
	for ( i = 0 ; i < nItemCount; i ++)
	{
		...
		pItemData->idurability		= 10;//fix do ben trang bi khi moi tao nhan vat
		pItemData->igoldid		= 0;
		pItemData->istacknum		= 0;
		pItemData->ienchance		= 0;
		pItemData->ipoint		= 0;
		pItemData->iyear		= 0;
		pItemData->imonth		= 0;
		pItemData->iday		= 0;
		pItemData->ihour		= 0;
		pItemData->ilockbh		= 0;
		pItemData->igiomokhoa		= 0;
		pItemData->iiduphong1		= 0;//#phi phong
		pItemData->iiduphong2		= 0;//#sè lÇn sö dông item
		pItemData->iiduphong3		= 0; //ngo¹i trang item ph¸t s¸ng
		pItemData->iiduphong4		= 0;
		pItemData->iiduphong5		= 0;
		pItemData->iiduphong6		= 0;
