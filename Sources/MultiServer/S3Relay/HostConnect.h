...
private:
	...
	void Proc0_ServerMaps(const void* pData, size_t size);
...
private:
	...
	typedef std::map<UINT, UINT>	stdHostServer;
	static stdHostServer m_sHostServer;

	typedef std::map<INT,INT>	SERMAP;
	SERMAP	m_serMaps;
