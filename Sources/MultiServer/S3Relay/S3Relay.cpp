...
LONG WINAPI ExeptionFillert(LPEXCEPTION_POINTERS lpExceptionInfo)
{
	...
	return GenerateMiniDump(NULL, lpExceptionInfo, L"s3relay");
}
		...
		case WM_INITDIALOG:
			{
				...
				::SetDlgItemText( hDlg, IDC_EDIT_NAME, userNameL2);
				::SetDlgItemText( hDlg, IDC_EDIT_PSWD, passWordL2);

				TCHAR buffer[_MAX_PATH];//auto login s3relay
