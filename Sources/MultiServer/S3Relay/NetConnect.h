...
public:
	...
	unsigned int getSerRegIndex() {return nServerIndex;}
	void setSerRegIndex(unsigned int index) {nServerIndex = index;}

	unsigned int getGsNumber() {return nGsNumber;}
	void setGsNumber(unsigned int index) {nGsNumber = index;}
