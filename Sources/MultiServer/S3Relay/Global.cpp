...
CTongSet g_cTongSet;
_DATABASEINFO m_DatabaseInfo;
S3PDBConVBC* pConnectDB;
...
BOOL gInitialize()
{
	...
	const unsigned short portDB = gGetPrivateProfileIntEx(sec_dbrole, "port", file_relaycfg, ROLEDBSVR_ROLEDB_PORT);
