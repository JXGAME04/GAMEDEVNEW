...
public:
	BOOL B_QueryChannelID(const std::_tstring& channel, DWORD ip, unsigned long param, DWORD nameid, DWORD nServerip);
...
private:
	BOOL Block_QueryChannelID(const std::_tstring& channel, DWORD ip, unsigned long param, DWORD nameid, DWORD nServerip);
