...
public:
	...
	BitMapProgress	m_progressCurrent;
	BitMapProgress	m_progress;
	CStatic	m_DisplayVersionCtl;
	CGdipButton	m_CancelButton;
	CGdipButton	m_RetryButton;
	CGdipButton	m_GameOption;
	CGdipButton 	m_EnterGameButton;
	CGdipButton	m_RegAccount;
	CGdipButton	m_PayCard;
	//CCQImageButton m_button1;
