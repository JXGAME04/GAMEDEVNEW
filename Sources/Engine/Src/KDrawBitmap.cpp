...
//---------------------------------------------------------------------------
// Function: DrawBitmap
// Function: Draw 256-color bitmap
// Parameters: void* node, void* canvas
// Return: void
//---------------------------------------------------------------------------
void g_DrawBitmap(void* node, void* canvas)
{
	...
	// Calculate the offset of the next line of the screen
	long ScreenOffset = nPitch - Clipper.width * 2;

	// Calculate the offset of the next line of the bitmap
	long BitmapOffset = nWidth - Clipper.width;

	// Assembly code for drawing functions
#ifdef _WIN64
#else
	__asm
	{
