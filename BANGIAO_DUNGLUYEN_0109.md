...
- **Bộ `.moi` cuối** (phiên bot wauto-68 gộp đợt e vào server): `CoreServer.dll.moi` = `9fba7a25fe16` (= B0D3596B + KPlayerBot đợt e; bản B0D3596B backup `_moi_backup9_b0d3596b\`), `CoreClient.dll.moi` = `2C14866841D3`, `Game.exe.moi` = `6AA1FEB9C55B`. Checklist mục 6.5 giữ nguyên, chỉ thay md5 server ở bước 3 thành `9FBA7A25…`.
