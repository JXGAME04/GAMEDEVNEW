...
7. Restart mà chưa làm bước 1-4 thì vẫn chạy bản cũ. Kiểm nhanh: md5 `CoreClient.dll` = `59f90510…` (đợt 3 tối 03/09; `4c69d7ad` đợt 2 đang chạy từ ~20:05), `Game.exe` = `71dae629…` (đang chạy, MAIL D7), `CoreServer.dll` = `b68899b2…` (đang chạy, S13k).
