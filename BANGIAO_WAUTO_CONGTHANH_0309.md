...
7. Restart mà chưa làm bước 1-4 thì vẫn chạy bản cũ. Kiểm nhanh: md5 `CoreClient.dll` = `ca5adaed…` (đợt 5 đêm 04/09, đi cùng `CoreServer.dll` = `a0361438…`; `59f90510` đợt 3 đang chạy từ 20:51, `CoreServer.dll` đang chạy = `b68899b2…`), `Game.exe` = `71dae629…` (đang chạy, MAIL D7), `CoreServer.dll` = `b68899b2…` (đang chạy, S13k).
