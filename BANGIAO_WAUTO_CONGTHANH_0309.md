...
7. Restart mà chưa làm bước 1-4 thì vẫn chạy bản cũ. Kiểm nhanh: md5 `CoreClient.dll` = `4c69d7ad…` (đợt 2 tối 03/09; `a3cecb53` là bản đang chạy từ 18:10), `Game.exe` = `71dae629…` (đang chạy, MAIL D7), `CoreServer.dll` = `b68899b2…` (đang chạy, S13k).
