...
def v_wndwindow(s):
    ...
    moi = ("\t{" + NL
           ...
           + "\t\t\tif (dJx > g_dJxUiMaxMs) { g_dJxUiMaxMs = dJx; g_pJxUiMax = this; g_nJxUiMaxX = m_nAbsoluteLeft; g_nJxUiMaxY = m_nAbsoluteTop; g_nJxUiMaxW = m_Width; g_nJxUiMaxH = m_Height; g_pszJxUiMaxLop = UiTenLopPhu(); }" + NL
           + "\t\t}" + NL
           + "#endif" + NL
           + "\t}" + NL
           + "\tif (m_pNextWnd)" + NL + "\t\tm_pNextWnd->Paint();" + NL + "}" + NL)
