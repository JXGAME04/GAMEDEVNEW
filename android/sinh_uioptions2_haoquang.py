...
[ToggleOptionsName] 7..8 = Vong quai / Sang vat roi (14/09 d: bo Vong do mac) (TCVN3 qua vn_edit.vn, ten <= 12 ky tu de khong bi cat o nut rong 72 px).
...
TEN = [u"V\u00f2ng qu\u00e1i", u"S\u00e1ng v\u1eadt r\u01a1i"]   # 7, 8 (14/09 d: bo Vong do mac)
...
for p in DICH:
    ...
    if k < 0:
        k = len(s2)
    them = nl + "; " + DAU_HIEU + " 3 cong tac hieu ung: 7 vong hao quang quai tinh anh/boss (Core KNpc.cpp), 8 cot sang + loe vat pham roi (Core KObj.cpp); 14/09 d bo Vong do mac theo chu; Top 101 -> 70 (5 hang)"
