...
for i in range(4):
    INI += ["[Nhom%d]" % i, "Left=%d" % (RAIL + i * NHOM_BUOC), "Top=34", "Width=%d" % NHOM_W, "Height=30", "Trans=0",
            ...
            "Font=14", "Color=230,230,230", "OverColor=255,255,160", "SelectColor=255,255,0", "DisableColor=120,120,120", ""]
TAB_W = 84
...
for i in range(8):
    INI += ["[Tab%d]" % i, "Left=%d" % (RAIL + i * TAB_BUOC), "Top=70", "Width=%d" % TAB_W, "Height=22", "Trans=0",
            ...
            "Font=12", "Color=230,230,230", "OverColor=255,255,160", "SelectColor=255,255,0", "DisableColor=120,120,120", ""]
INI += [
    "[TenTab]",
