...
Đồ họa: client JX1 đã có động tác/res 268 "Vũ Hồn Tân Thủ-Đao" (SwordShieldW*), 269 "-Thuẫn" (ShieldSwordW*), 276 "逍遥琴1" (GuqinW*) và thân 156-157 "Bộ Vũ Hồn 1/2"; mọi truy cập NpcRes có kiểm biên → không crash; **spr động tác thuẫn/cầm có trong pak chưa: chưa xác minh** (thiếu → ảnh trống). Bảng đặc lệ VLTK (`PartFileNameSpecial`) engine JX1 không có → chỉ thẩm mỹ.
