...
-- [GOHECU 30/08] Boss Sat Thu ban Viet - cum 3HD ban Linux thay the (BAT_HD3=1); startgame khong goi ham nao cua thu vien nay
-- Include("\\script\\tinhnang\\boss_satthu\\lib_boss_st.lua")
Include("\\script\\tinhnang\\boss_hoangkim\\lib_bosshk.lua")
-- [GOHECU 30/08] Phong Lang Do ban Viet - da TAT tu 25/08 (startgame.lua:102); startgame khong goi ham nao cua thu vien nay
...
Include("\\script\\missions\\tongcastle\\tongcastle_driver.lua")
Include("\\script\\tinhnang\\3hoatdong\\hd3_driver.lua")	-- [3HD 25/08] San boss Sat Thu + Phong Lang Do + Vuot Ai (ban Linux)	-- [TONGCASTLE 23/08] Bang Hoi Thanh Bao
...
-- [GOHECU 30/08] he Boss Sat Thu ban Viet da go; addnpcsatthu() khong ai goi (startgame.lua:103 va :210 deu da comment)
...
Include("\\script\\startgame\\lmbj_addnpc.lua")	-- [LMBC 06/09] NPC van tieu Long Mon Tieu Cuc
...
function OnGame()
	...
	if (YDBZ_DriverInit ~= nil) then YDBZ_DriverInit() end	-- [VIEMDE 26/08] dat NPC bao danh
	...
	bw_addnpc()	-- [BW 23/08]
	lmbj_addnpc()	-- [LMBC 06/09] sinh 45 NPC van tieu (bang + ca nhan)
	
	--===== Add Trap=====--

	
	add_npc_hoason()	-- [HOASON 01/09] Linux npc_hoason.lua: quai + NPC map 987 + Hoa Son Kiem Khach 8 thon
	add_npc_vhtd()	-- [VHTD 02/09] NPC nhap mon Vu Hon / Tieu Dao 8 thon
	addfullnpc()
