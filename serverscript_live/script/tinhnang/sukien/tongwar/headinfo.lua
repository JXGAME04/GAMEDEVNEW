...
local tongwar_citynamecheck
Include("\\script\\header\\cauhinh_hoatdong.lua")	-- [HD CONFIG 24/08] bang thuong Bang Chien chinh duoc
IL("FILESYS");
IL("ITEM");
IL("LEAGUE");
IL("SETTING");
...
TAB_AWORD_GOOD = 
		{
			{{tbProp={6,1,4864 ,1},szName="Qu¶ §¹i Hoµng Kim",nExpiredTime=10080}, {30, 15, 10, 10, 5, 0, 0}},	--»Æ½ðÖ®ÖÖµÄ½±ÀøÁÐ±í
			--{{tbProp={6,1,1075,1},szName="LÔ hép qu¶ huy hoµng"}, {150, 100, 80, 60, 50, 30, 10}},	--»Ô»ÍÖ®ÖÖµÄ½±ÀøÁÐ±í
			{{tbProp={6,1,2273,1},szName="Hoµng Ch©n §¬n",tbParam={0,20}}, {20, 15, 10, 5, 5, 5, 0}},	--×Ï½ðÕæµ¤£¨20ÒÚ£©µÄ½±ÀøÁÐ±í
			--{{szName="Cuång Lan 5%",tbProp={0,4491},nQuality = 1,nExpiredTime=30*24*60,}, {10, 5, 0, 0, 0, 0, 0}},	--Ç§Äê»Ô»ÍÖ®¹ûµÄ½±ÀøÁÐ±í
			{{szName="Cuång Lan 5%",tbProp={0,4491},nQuality = 1,nExpiredTime=30*24*60,}, {10, 5, 0, 0, 0, 0, 0}},
			--VLDNB 11 - Modified By DinhHQ - 20120507
			{{tbProp={6,1,4857,1},szName="Hçn nguyªn ch©n ®¬n"}, {30, 20, 10, 5, 5, 5, 5}},			
			{{szName="Phi Phong CÊp PhÖ Quang (hãa gi¶i s¸t th­¬ng)",tbProp={0,3476},nQuality = 1,nExpiredTime=90*24*60,}, {1, 0, 0, 0, 0, 0, 0}},	--ÐþÔ³ÁîµÄ½±ÀøÁÐ±í
...
-- [HD CONFIG 24/08] de bang thuong tu config (thay ca bang neu co)
if (tbCHD and tbCHD.TW_THUONG) then
	TAB_AWORD_GOOD = tbCHD.TW_THUONG
end
