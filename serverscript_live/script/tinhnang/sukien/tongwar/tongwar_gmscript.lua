...
function tongwar_redo_start(...) local arg = {n = select("#", ...), ...};
	local aryParam = arg
	local szParam = ""
	for i = 1, 9 do
...
-- [HD ADMIN 24/08] wrapper cho Lenh Bai Admin (DynamicExecute khong goi vararg truc tiep)
function HD_TW_RedoStart(a1, a2, a3, b1, b2, b3, c1, c2, c3)
	return tongwar_redo_start(a1, a2, a3, b1, b2, b3, c1, c2, c3)
end
