...
function submit_zhuigongling(nCount)
	...
	if (ng == 6 and nd == 1 and np == 2024) then
		...
		-- [KM 28/08] chuan 1001 config[26] FLD_Collect_Item_VNG: 5 CND (dai)/lan nop
		AddItemSL(4847, 5, 0)
		Msg2Player("Nép Truy C«ng LÖnh: nhËn thªm 5 Ch©n Nguyªn §¬n (®¹i).")
