...
local WLLS_DATA = {
	...
	award_rank = {
		{	--ÅÅĞĞ½±Àø£¬ĞÂĞã
			...
			{3, 5000, nil, {tbProp=tbLianSaiLiBao,nCount=10}, {tbProp={6,1,4550,1,0,0}, nCount=10}},	--µÚ3Ãû
			{4, 4000, nil, {tbProp=tbLianSaiLiBao,nCount=8}, {tbProp={6,1,4550,1,0,0}, nCount=8}},	--µÚ4Ãû
			...
			{64, 300, nil},	--µÚ33-64Ãû
			{128, 200, nil},	--µÚ65-128Ãû
		}
	},
