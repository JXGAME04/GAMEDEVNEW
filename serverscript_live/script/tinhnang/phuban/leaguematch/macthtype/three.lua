...
local WLLS_DATA = {
	...
	award_rank = {
		{	--ÅÅÐÐ½±Àø£¬ÐÂÐã
			...
			{2, 8000, nil, {tbProp=tbLianSaiLiBao,nCount=16}, {tbProp={6,1,4550,1,0,0}, nCount=16}},	--µÚ2Ãû
			...
			{8, 4000, nil, {tbProp=tbLianSaiLiBao,nCount=8}, {tbProp={6,1,4550,1,0,0}, nCount=8}},	--µÚ5-8Ãû
			{16, 3000, nil, {tbProp=tbLianSaiLiBao,nCount=6}, {tbProp={6,1,4550,1,0,0}, nCount=6}},	--µÚ9-16Ãû
			{32, 2000, nil, {tbProp=tbLianSaiLiBao,nCount=4}, {tbProp={6,1,4550,1,0,0}, nCount=4}},	--µÚ17-32Ãû
			{64, 1000, nil, {tbProp=tbLianSaiLiBao,nCount=2}, {tbProp={6,1,4550,1,0,0}, nCount=2}},	--µÚ33-64Ãû
		}
	},
