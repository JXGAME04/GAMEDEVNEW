	...
	if (n_lid ~= 0) then
		...
		if (n_phase >= 2) then
			...
			if (n_wday == 0 or n_wday >= 5) then
				Msg2Player("hiÖn t¹i lµ kú thi liªn ®Êu vâ l©m, h«m nay <color=yellow>18:00~19:00<color>  <color=yellow>20:00~21:00<color> s¾p diÔn ra <color=yellow>8<color> trËn"..WLLS_LEVEL_DESC[n_level]..".")
			else
