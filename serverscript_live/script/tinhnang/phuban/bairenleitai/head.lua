Include("\\script\\header\\cauhinh_hoatdong.lua")	-- [HD CONFIG 24/08] nhip dau chinh duoc (RESTART moi ap dung)
-- ====================== ÎÄ¼þÐÅÏ¢ ======================
...
tbTimerInfo = {
	nApply = HD_CFG("BR_GIAY_CHO_KHIEUCHIEN", 30)*18,		-- ÀÞÖ÷ÉÏÌ¨£¬µÈ´ýÊ±¼ä
	nPrepare = HD_CFG("BR_GIAY_DEM_NGUOC", 3)*18,		-- ÌôÀÞ×¼±¸Ê±¼ä
	nFight = HD_CFG("BR_PHUT_MOI_LUOT", 3)*60*18,--3*60*18,	-- ±ÈÈüÊ±¼ä
...
HA_MAXSTAYTIME = HD_CFG("BR_PHUT_DUNG_YEN", 90)*60	-- 90·ÖÖÓ×î³¤Í£ÁôÊ±¼ä
HA_DOUBLETIME = HD_CFG("BR_PHUT_BUFF_X2", 30)*60	-- 30·ÖÖÓË«±¶Ð§¹û
