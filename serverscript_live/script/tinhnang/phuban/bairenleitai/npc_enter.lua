...
local onEnterHunbredArena, onHelpHunbredArena
-- ====================== ÎÄ¼þÐÅÏ¢ ======================
...
-- ======================================================
Include("\\script\\dailogsys\\dailogsay.lua")	-- [JX1 23/08] npcdailog keo 18 tep bonusvlmc/vng khong port; chi can CreateNewSayEx
Include("\\script\\missions\\basemission\\lib.lua")
Include("\\script\\lib\\log.lua")

-- [KIEM CHUNG 24/08] ban Linux dung MOT lua_State chung nen `oncancel` (ham RONG,
-- khuon missions\tong\collectgoods\award.lua:157) luon co san. JX1 moi tep mot state
-- nen o day `oncancel` = nil => bam "Ket thuc doi thoai" co the nem loi script.
function oncancel()
end
