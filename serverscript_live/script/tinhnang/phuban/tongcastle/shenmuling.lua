Include("\\script\\header\\cauhinh_hoatdong.lua")	-- [HD CONFIG 24/08] thuong Than Moc Lenh chinh duoc
...
MAX_COUNT_PER_WEEK = HD_CFG("TC_LENH_TUAN", 5)
...
if (tbCHD and tbCHD.TC_THUONG_LENH) then
	tbAward = tbCHD.TC_THUONG_LENH
end
