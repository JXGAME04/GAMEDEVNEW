...
-- [LOI DAI CN 22/08] engine JX1 goi OnPlayerDeath(nVictimPIdx, nKillerNpcIdx) (KNpc.cpp:1542),
-- ban goc OnDeath(Launcher) - cau noi y het citywar_city\playerdeath.lua
