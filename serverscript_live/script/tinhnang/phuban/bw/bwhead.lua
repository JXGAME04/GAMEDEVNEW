...
CS_CamperPos = {
				{1599, 3202, "Tr­¬ng Tam"},
				{1608, 3211, "Lı T­"},	-- [BW 23/08] ten hong san o ban VNG
}
FRAME2TIME = 18;
--ÓÎÏ·µÄ×î´óÈËÊı
MAX_MEMBER_COUNT = 100;
--´æ´¢Íæ¼ÒµÄÎ»ÖÃµÄÈÎÎñ±äÁ¿
BW_SIGNPOSWORLD = 2340;	-- [BW 23/08] 300-302 cua JX1 = task luu/khoi phuc Tong Kim
BW_SIGNPOSX = 2341;
BW_SIGNPOSY = 2342;
MS_STATE = 1;
MS_MAXMEMBERCOUNT = 2;
...
MSS_CAPTAIN = {1, 2};
BW_SMALLTIME_ID = 20;	-- [BW 23/08] khe timer: 10 cua JX1 dang song (task10.lua) --¶¨Ê±´¥·¢Æ÷
BW_TOTALTIME_ID = 21;	-- [BW 23/08] 
TIMER_1 = 20 * FRAME2TIME; -- 20Ãë¹«²¼Ò»ÏÂÕ½¿ö
TIMER_2 = HD_CFG("BW_PHUT_TRAN", 12) * 3 * TIMER_1 ; --½»Õ½×ÜÊ±¼äÎª10+2·ÖÖÓ

GO_TIME = HD_CFG("BW_PHUT_CHO", 2) * 3; -- ±¨ÃûÊ±¼äÎª2·ÖÖÓ
BW_MISSIONID = 11;	-- [BW 23/08] khe mission: 4 cua JX1 = Phong Lang Do; 11 = mission_trong
...
function GameOver()
	...
	for i  = 1, PCount do 
		PlayerIndex = PTab[i];
		LeaveGame();	-- [BW 23/08] JX1 khong go mission khi doi map (C11) - giong citywar_arena/head.lua:75
