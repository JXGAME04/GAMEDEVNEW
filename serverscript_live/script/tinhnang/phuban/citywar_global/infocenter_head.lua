...
nCityWar_Item_ID_P = 1508	-- DOT E: goc 1499; cay ta 'Khieu chien lenh' = magicscript.txt row (6,1,1508)		--¹¥³ÇÕ½ÐÅÎïP ID
...
function sure_takeQingtongDing(ncount)
	...
	if (checkIsTakeQingtongDing(szTongName, nTongID, nCityId) == 1) then
		...
		if (nFree > 6) then
			...
			for i =1, ncount do
				AddItem(nCityWar_Item_ID_G,nCityWar_Item_ID_D,nCityWar_Item_ID_P,1,0,0,0);--qingtongding
			end;
