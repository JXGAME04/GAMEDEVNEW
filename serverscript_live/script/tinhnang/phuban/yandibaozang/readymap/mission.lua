...
local YDBZ_ready_match_timer, YDBZ_ready_signup
-- 
-- by 
-- 2007.10.24
-- ÎÒ..
...
function OnLeave(index)
		...
		if nteamsum < YDBZ_TEAM_COUNT_LIMIT and tbReady.ReadyState ~= 3 and GetTaskTemp(200) == 1   then
			local tbplayer = {}
			for nj = 1, 10 do
