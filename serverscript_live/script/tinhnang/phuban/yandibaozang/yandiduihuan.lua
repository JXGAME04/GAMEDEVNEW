...
IncludeLib("ITEM")
-- [JX1 26/08 compat] bo sung GetItemBindState (JX1 goi ten khac)
Include("\\script\\missions\\yandibaozang\\ydbz_compat.lua")
...
{
	{szName="Ph­îng Minh Chïy", tbProp={6, 1, 1755}},
	{szName="HuyÒn tinh kho¸ng th¹ch cÊp 8", tbProp={6, 1, 146, 8}},
	{szName="M¶nh Bæ Thiªn Th¹ch (trung)", tbProp={6, 1, 1314}},
	{szName="ThÇn bÝ kho¸ng th¹ch", tbProp={6, 1, 397}},
}
...
function yandiduihuan_LogEquip(nItemIndex, szLogTitle)
	...
	local szLogMsg = format("%s, {%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d,%d}", szItemName, 4,uRandSeed,nQuality,nGenre,nDetailType,nParticular,nLevel,nSeries,nLuck,arynMagLvl[1],arynMagLvl[2],arynMagLvl[3],arynMagLvl[4],arynMagLvl[5],arynMagLvl[6])
