...
function tongwar_dorelay(...) local arg = {n = select("#", ...), ...};
...
function bt_RankEffect(rank)
	...
	-- [FIX 25/08] he JX2 khong dat m_btPlayerTitle nen danh hieu KHONG HIEN tren nhan vat;
	-- goi them he JX1 (bang settings\PlayerTitle.txt, dong 288-292 = id 287-291).
	SetPlayerTitle(287 + rank - 1, 9999999, 0)
