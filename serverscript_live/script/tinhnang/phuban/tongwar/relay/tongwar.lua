...
LEAGUE_NUMBER = 7
TONGWAR_STATETIME = HD_CFG("TW_GIO_KHAICHIEN", 2000)
TONGWAR_ENDTIME = HD_CFG("TW_GIO_KETTHUC", 2130)
...
--  ID = {[1]±¨Ãû¿ªÊ¼ÈÕ,[2]±ÈÈüÆğ,	[3]±ÈÈüÖ¹,	[4]½±ÀøÆğ,	[5]½±ÀøÖ¹}
	...
	--Season 9 - JX1 port 23/08/2026: TRUNG khoa ngay 29,30,31,1,2,3,5 cua SCHEDULE_TABLE (nhu mua 8)
	[9] = {261029, 		261029,		261105,		261106,		261111},
}
-- [HD CONFIG 24/08] de mua 9 tu config (doi ngay PHAI giu trung khoa ngay 29,30,31,1,2,3,5
-- cua SCHEDULE_TABLE - xem chu thich trong cauhinh_hoatdong.lua)
if (tbCHD and tbCHD.TW_MUA9) then
	TONGWAR_SEASON_TB[9] = tbCHD.TW_MUA9
end
...
function tongwar_GetCurSeason(nDate)
	...
	for i, tb in pairs(TONGWAR_SEASON_TB) do
...
function tongwar_initmatch(nseason)
	...
	for strCityTongName, tbCity in pairs(tbTongSet) do
