...
BigBoss.tbNormalDrop = 
{
	...
	{tbProp = {6,1,6,1,0,0}, nCount=20},
	{tbProp = {6,1,3,1,0,0}, nCount=20},
...
BigBoss.tbVngNewAward = 
{
	[1] = {--Ph«n 1
		...
		{szName="ßπi Thµnh B› K›p 150",tbProp={6,1,3208,1,0,0},nCount=1,nRate=0.7},
		{szName="Thi™n S¨n Th∏nh ThÒy (Æπi)",tbProp={6,1,3211,1,0,0},nCount=1,nRate=7.95,nExpiredTime=43200},
	...
	[4] = {--Ph«n 5
		{szName="TÛi D≠Óc Ph»m",tbProp={6,1,4813,1,0,0},nCount=5,nRate=20},
	...
	[7] = {--Ph«n 5 Ph«n th≠Îng ßªng Long
		...
		{szName="ßÂ PhÊ ßªng Long BÈi",tbProp={6,1,4869,1,0,0},nCount=1,nRate=1},
		...
		{szName="ßªng Long Thπch - Hπ",tbProp={6,1,4866,1,0,0},nCount=10,nRate=77},
		{szName="Tinh S≠¨ng L÷nh",tbProp={6,1,4860,1,0,0},nCount=1,nRate=2},
		{szName="Huy“n Thi’t",tbProp={6,1,4861,1,0,0},nCount=1,nRate=3},
	},
	[8] = {--Ph«n 4
...
-- [KM 28/08] chuan 1001 config[11] BossHK: 2 CND (trung) cho nguoi ha boss
function KM_ThuongBossHK()
	AddItemSL(4846, 2, 0)
	Msg2Player("ß∏nh bπi ßÈc C´ Thi™n Phong: nhÀn 2 Ch©n Nguy™n ß¨n (trung).")
end
...
function BigBoss:BigBossDeath(nNpcIndex)
	...
	if (nTeamSize > 1) then
		for i=1,nTeamSize do
			...
			doFunByPlayer(GetTeamMember(i), KM_ThuongBossHK)	-- [KM 28/08]
		end
	else -- “ª∏ˆ»À
		szName = GetName();
