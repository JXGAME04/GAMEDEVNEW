...
function tbTalkDailyTask:AcceptTask()
	...
	tbAwardTemplet:GiveAwardByList({szName="Th­ cña Long Nhi",tbProp={6,1,2580,1,0,0}}, "TiÕp nhËn nhiÖm vô ®èi tho¹i nhËn ®­îc th­ cña Long Nhi");
...
function tbTalkDailyTask:TalkToNpc()
	...
	if (PlayerFunLib:CheckItemInBag({tbProp={6,1,2580,-1,-1,0}}, 1, "§¹i hiÖp th­ cña ng­¬i ®©u?") ~= 1) then
		return nil;
	end
	
	PlayerFunLib:ConsumeEquiproomItem({tbProp={6,1,2580,-1,-1,0}}, 1)
