--Author: Fong KiÒu skill C«n L«n
...
SKILLS={
	...
	yiqi_sanqing={ --Nhat Khi Tam thanh
		addphysicsdamage_p={{{1,35},{20,215}},{{1,18*120},{20,18*120}},{{1,6},{2,6}}}, --tham s?th?3 b»ng 1 l?buff cho ®­êng ®ao 6 buff tÊt c?c¸c ®­êng
	...
	zuixian_cuoguzzzz={ --Tuy Tien Ta cot
		--fastwalkrun_p={{{1,-12},{20,-52}},{{1,18*45},{20,18*120}}},
		-- freezetimereduce_p={{{1,-5},{20,-50}},{{1,18*45},{20,18*120}}},
		-- stuntimereduce_p={{{1,-5},{20,-50}},{{1,18*45},{20,18*120}}},
		-- addpoisondamage_v={{{1,-5},{20,-55}},{{1,18*45},{20,18*120}}},
		lifereplenish_v={{{1,-5},{20,-55}},{{1,18*45},{20,18*120}}},
		manareplenish_v={{{1,-5},{20,-70}},{{1,18*45},{20,18*120}}},
		-- rangedamagereturn_p={{{1,-5},{20,-35}},{{1,18*45},{20,18*120}}},
...
--		},
	...
	kunlun120={ --Luong Nghi Chan khi 120
		autorescueskill={{{1,721*256 + 1},{20,721*256 + 20},{21,721*256 + 21}},{{1,-1},{20,-1}},{{1,20*18*256 + 15},{15,20*18*256 + 45},{20,20*18*256 + 65},{21,20*18*256 + 65}}},
		skill_desc=
			function(level)
				...
				" lÇn<color> møc néi lùc hé th©n trong <color=orange>"..floor(Link(level,SKILLS.kunlun120mofadun.staticmagicshield_p[2]) / 18).." gi©y<color>\n"..
	...
	kunlun120mofadun={ --Ma Phap Don 120
		staticmagicshield_p={{{1,1800},{15,9750},{20,10000},{21,10050}},{{1,2*18},{15,4*18},{20,5*18},{21,5*18}}},
		skill_eventskilllevel={{{1,1},{20,20}}},
	},
	kunlun120jiasu={ --Gia Toc 120
		fastwalkrun_p={{{1,5},{15,30},{20,35},{21,36}},{{1,2*18},{15,4*18},{20,5*18},{21,5*18}}},
	},
