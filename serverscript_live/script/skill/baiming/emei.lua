...
SKILLS={
	...
	emei_zhangfa={ --峨嵋掌法
		addcoldmagic_v={{{1,15},{20,635}},{{1,-1},{2,-1}}}
	},
	...
	liushui={--流水
		expenhance_p={{{1,100},{20,100}},{{1,18},{2,18}}}
	},
	bumie_bujue={ --不灭不绝
	...
	sane_jixue={ --三峨霁雪
		physicsenhance_p={{{1,10},{15,400},{20,697}}},
		skill_misslenum_v={{{1,1},{11,2},{20,3},{21,3}}},
	...
	fengshuang_suiying={ --风霜碎影
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		colddamage_v={
			[1]={{1,20},{15,750},{20,2070}},
			[3]={{1,30},{15,900},{20,2500}}
		},
		skill_eventskilllevel={{{1,1},{20,20}}},
		skill_cost_v={{{1,30},{20,65}}},
		skill_startevent={
	...
	jinding_foguang={ --金顶佛光
		colddamage_v={
			[1]={{1,10},{20,785},{21,1300}},
			[3]={{1,10},{20,785},{21,1300}},
		},
		seriesdamage_p={{{1,20},{20,60},{21,62}}},
