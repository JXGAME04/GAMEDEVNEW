...
SKILLS={
	...
	xinyan={ --Tam Nhan
		addcolddamage_v={{{1,10},{30,110}},{{1,-1},{2,-1}}}, --bang sang
		addpoisondamage_v={{{1,1},{30,10}},{{1,-1},{2,-1}},{{1,10},{2,10}}}, -- doc sat ngoai
		addphysicsdamage_p={{{1,15},{20,115}},{{1,-1},{2,-1}},{{1,7},{2,7}}}, --sat thuong vat ly
		poisonenhance_p={{{1,3},{30,33}},{{1,-1},{2,-1}}}, --thoi gian doc phat
		deadlystrikeenhance_p={{{1,8},{30,26}},{{1,-1},{2,-1}}}, --tan cong chi mang
		attackspeed_v={{{1,29},{30,106},{33,113},{34,116},{35,149},{38,156},{39,159},{40,162}},{{1,-1},{2,-1}}},--toc do danh
	},
	...
	shehun_yueying={ --Nhiep hon Nguyet Anh
		physicsenhance_p={{{1,25},{15,150},{20,360}}},
	...
	baoyu_lihua={ --Bao Vu Le hoa
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}}, --ngu hanh tuong khac
		physicsenhance_p={{{1,15},{15,200},{20,434}}}, --sat thuong vat ly
	...
	zhuixing_zhudian={ --Truy Tinh Truc Dien
		seriesdamage_p={{{1,20},{20,60},{21,62}}}, --ngu hanh tuong khac
		poisondamage_v={{{1,1},{20,10}},{{1,60},{20,60}},{{1,10},{20,10}}}, --doc sat
	},
