	...
	if Uworld1082 >= 141 and Uworld1082 <= 160 then
		...
		local tbAward = {
			[1] = {
				...
				{szName="§iÓm kinh nghiÖm",nExp=HD_CFG("HD3_ST_EXP_QUAY",5000000),nRate=68.2639},
				...
				{szName="§å Phæ §»ng Long Béi",tbProp={6,1,4869,1,0,0},nCount=1,nRate=0.0003},
				...
				{szName="§»ng Long Th¹ch - H¹",tbProp={6,1,4866,1,0,0},nCount=1,nRate=0.16},},
