...
local ture_real_starttask_one, ture_real_starttask
-------------------------------------------------------------------------
...
--Fix bug vÉn pk ®c trong thµnh nÕu dŞch chuyÓn b»ng npc DŞch Quan khi hoµn thµnh nhiÖm vô tİn sø - Modified by DinhHQ - 20110518
	...
	elseif ( nt_getTask(1203) == 10 ) or ( nt_getTask(1203) == 0 ) or ( nt_getTask(1203) == 20) or ( nt_getTask(1203) == 21 ) then
		-- [FIX 25/08 roi map] dang lam do (20) ma roi bang duong tat nay thi dat TAM NGAT (21)
		-- - dung pattern messenger_icantdo (turenpc.lua:169) cua chinh Kingsoft. Linux giu 20
		-- van lam tiep duoc vi engine Linux khong khoa danh-quai theo rut-vu-khi; engine JX1
		-- co khoa (KNpcSet.cpp:1553) nen phai hoi tu ve 21 de 'Tiep tuc' bat lai du trang thai.
