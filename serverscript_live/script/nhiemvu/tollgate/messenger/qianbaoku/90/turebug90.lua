...
local set_team_task_temp181, is_near, real_set_task_temp181
-------------------------------------------------------------------------
...
-- [FIX 25/08] engine JX1 goi OnRevive khi npc hoi sinh (KNpc.cpp:8676) VO DIEU KIEN;
-- ban Linux khong co ham nay (engine Linux khong goi kieu do) -> 36 ScriptError moi
-- lan boot. Ham RONG - khong doi hanh vi.
