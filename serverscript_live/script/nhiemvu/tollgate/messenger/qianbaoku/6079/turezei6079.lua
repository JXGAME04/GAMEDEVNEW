...
TUREREFRESH_EXP =tonumber( TabFile_GetCell( "tollprize" ,8 ,"shuachu_exp"))  --Ð¡¹Ö¾­Ñé
TUREREFRESH_MAPID= 393  --Ç§±¦¿âµÄµØÍ¼id
TUREREFRESH_MESSENGEREXP= tonumber( TabFile_GetCell( "tollprize" ,8 ,"shuachu_jifen"))  --Ð¡¹Ö¾­Ñé
