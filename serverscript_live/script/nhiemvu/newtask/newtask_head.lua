...
----------------¹«¹²»ù±¾º¯Êı start-------------------
_C_AddGoldItem = _C_AddGoldItem or AddGoldItem -- [JX1 PORT 15/08/2026] giu ham C truoc khi bi dinh nghia de
function AddGoldItem(index, nGoldId)
	-- kieu goi JX2 (mySG cua Da Tau): AddGoldItem(0, maHK) -> ham C nhan maHK o tham so dau
	if (nGoldId ~= nil and nGoldId > 0) then
		return _C_AddGoldItem(nGoldId)
	end
	if (index == 184) then
