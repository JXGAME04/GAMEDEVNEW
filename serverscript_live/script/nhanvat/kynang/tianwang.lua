--Skill thi猲 vng bang author: Fong Ki襲
...
SKILLS={
	...
	tianwang_zhanyi={ --Thien Vuong chien y
		...
		deadlystrikeenhance_p={{{1,5},{30,48}},{{1,-1},{30,-1}}},
	...
	potian_zhan={ --Pha thien Tram
		physicsenhance_p={{{1,35},{15,150},{20,446}}},
	...
	zhuixing_zhuyue={ --Truy Tinh Truc Nguyet
		physicsenhance_p={{{1,50},{15,200},{20,458}}},
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
