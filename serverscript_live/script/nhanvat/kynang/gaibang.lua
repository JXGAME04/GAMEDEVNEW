...
SKILLS={
	...
	dagou_zhen={ --Da Cau bong phap da cau tran
		addphysicsdamage_p={{{1,10},{20,175}},{{1,18},{2,18}},{{1,6},{2,6}}},
		--skill_cost_v={{{1,24},{20,50}}}
	},
	...
	zuidie_kuangwu={ --Tuy diep cuong vu
		...
		lifemax_p={{{1,21},{35,20},{36,20}},{{1,-1},{30,-1}}}, --add by Fong Ki襲
...
--		skill_showevent={{{1,0},{15,0},{15,4},{20,4}}},
	...
	gaibang120={ --Hon Thien Khi cong 120
		...
		skill_desc=
			function(level)
				return "X竎 su蕋 <color=orange>"..floor(Link(level,SKILLS.gaibang120.autoattackskill[3]) - 12*18*256).."%<color> g﹜ ho筰 thng \n"..
				"Ho筰 thng l祄 gi秏 <color=orange>"..floor(-Link(level,SKILLS.gaibang120zuzhou.physicsres_p[1]))..
				"%<color> PTVL, gi秏 <color=orange>"..floor(-Link(level,SKILLS.gaibang120zuzhou.fireres_p[1]))..
				"%<color> KH,\n ng th阨 l祄 gi秏 gi?tr?PTVL l韓 nh蕋 <color=orange>"..floor(-Link(level,SKILLS.gaibang120zuzhou.physicsresmax_p[1]))..
				"%<color>, gi秏 gi?tr?KH l韓 nh蕋 <color=orange>"..floor(-Link(level,SKILLS.gaibang120zuzhou.fireresmax_p[1]))..
				...
				"Trong v遪g <color=orange>"..floor((Link(level,SKILLS.gaibang120.autoattackskill[3]) / (18*256))).." gi﹜<color> sau m韎 c?th?thi tri觧 ti誴"
			end,
