...
SKILLS.changyinghuichi={ --³¤Ó§»Ó³â
	...
	SKILLS.baijiangguzhanhan={ --¹Â½«°ÙÕ½º¨
		...
		allres_p={{{1,0},{29,0},{30,30},{31,30}},{{1,-1},{30,-1}}},
		fasthitrecover_v={{{1,0},{30,0},{31,15},{37,20},{38,20}},{{1,-1},{30,-1}}},
		--returnres_p={{{1,1},{30,20},{31,20}},{{1,-1},{30,-1}}},
		melee_returnres_p={{{1,0},{30,20},{31,20}},{{1,-1},{30,-1}}}, 
	}
	SKILLS.jicanhunurou={ --¼¢²ÍºúÂ²Èâ
	...
	SKILLS.keyinxiongnuxue={ --¿ÊÒûÐÙÅ«Ñª
	...
	SKILLS.zhongwuliufengBUFF={ --ÖÒÎäÁ÷·ç»ØÑªBUFF
		resume_life_p = {
			{{1,30},{28,60},{34,70},{35,71}}, -- »Ø°Ù·ÖÖ®¼¸,¸ºÊýÎÞÐ§
			{{1,1},{2,1}} -- ³ÖÐøÊ±¼ä£¬Ã¿Ö¡ÉúÐ§
		},
	}
	SKILLS.chanjianchuning={ --²ù¼é³ýØú
	...
	SKILLS.jingzhongbaoguo= --¾«ÖÒ±¨¹ú
	{
	 ...
	 SKILLS.fenyongdangxian={ --·ÜÓÂµ±ÏÈ
		fastwalkrun_p={{{1,10},{20,30}},{{1,5*18},{20,13*18},{21,13*18}}},--¼ÓÅÜËÙ
	 }
 ---¶ÜÏµ
 SKILLS.duozhai_yangqi={ --¶áÕ¯ÑïÆì
	...
	SKILLS.wuhuntang_dunfa={ --Îä»êÌÃ¶Ü·¨
...
--		skill_showevent={{{1,0},{10,0},{10,1},{20,1}}},
	...
	SKILLS.qingyin_tiruilv1={ --ÇëÓ§ÌáÈñÂÃ
	...
	SKILLS.qingyin_tiruilv2={ --ÇëÓ§ÌáÈñÂÃ
		candetonate1={
			[1]={{1,421*256+0},{2,421*256+0}},
			[3]={{1,36},{26,36},{31,36},{32,36}},
		},
	}
	SKILLS.huishi_mielu={ --»ÓÊ¦ÃðÂ²
	...
	SKILLS.huishi_mielu_2={ --»ÓÊ¦ÃðÂ²µÚ2Ê½
