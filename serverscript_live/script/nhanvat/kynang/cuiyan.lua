...
--		skill_cost_v={{{1,24},{20,100}}}
	...
	cuiyan120={ --Ngu tuyet An 120
		...
		fastwalkrun_p={{{1,1},{20,30},{21,30}},{{1,5*18},{15,25*18},{20,30*18},{21,30*18}}},--[SK120 07/09] nhu Linux 20141013
	...
	cuiyan120_1={
		attackspeed_v={{{1,100},{20,100}},{{1,18},{20,18}}},
		castspeed_v={{{1,100},{20,100}},{{1,18},{20,18}}},
	...
	daocuiyan150={ --Bang Tuoc Hoat ky -150
		...
		missle_speed_v={{{1,28},{20,28},{21,28}}},--[SK150 07/09] nhu Linux
		skill_attackradius={{{1,448},{20,512},{21,512}}},
	...
	neicuiyan150={ --Thuy Anh Man Tu -150
		...
		missle_speed_v={{{1,24},{20,28},{21,28}}},--[SK150 07/09] nhu Linux
		skill_attackradius={{{1,448},{20,512},{21,512}}},
