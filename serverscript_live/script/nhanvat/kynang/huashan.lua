...
SKILLS={}	-- [VHTD 02/09e] tach bang: tranh 'stack Overflow' Lua 4 khi 1 constructor lon (client ScriptError 4)

	--»ªÉ½
SKILLS.baihong_guanri={ --°×ºç¹áÈÕ
		physicsenhance_p={
			[1]={{1,30},{20,75}},
		},
...
--		deadlystrikeenhance_p={{{1,6},{20,36}},{{1,-1},{2,-1}}},
	...
	SKILLS.huanyan_yunyan={ --»ÃÑÛÔÆäÎ
		addcoldmagic_v={{{1,20},{30,315}},{{1,300*18},{2,300*18}}},
		addcolddamage_v={{{1,100},{30,315}},{{1,300*18},{2,300*18}}},
		--coldenhance_p={{{1,5},{9,5},{10,20},{19,20},{20,40},{29,40},{30,60},{39,60},{40,80},{49,80},{50,100},{51,100}},{{1,60*18},{2,180*18}}}, 
		coldenhance_p={{{1,5},{40,200},{40,205}},{{1,300*18},{2,300*18}}},
		lifemax_yan_p={{{1,10},{25,35},{36,55},{37,55}},{{1,300*18},{2,300*18}}},
		me2firedamage_p={{{1,1},{30,20},{31,20}},{{1,300*18},{2,300*18}}},--¶Ô»ðÏµÉËº¦Ôö¼Ó£º15%
		fire2medamage_p={{{1,1},{30,20},{31,20}},{{1,300*18},{2,300*18}}},--¼õÉÙÀ´×Ô»ðÏµµÄÉËº¦£º15%
		anti_block_rate={{{1,1},{10,10},{30,30},{31,30}},{{1,300*18},{2,300*18}}},
		--fasthitrecover_yan_v={{{1,1},{10,5},{40,20},{41,20}},{{1,-1},{2,-1}}},
		fasthitrecover_yan_v={{{1,1},{40,0},{41,15},{47,20},{48,20}},{{1,300*18},{2,300*18}}},
		--anti_do_hurt_p={{{1,0},{29,0},{30,5},{40,10},{41,10}},{{1,300*18},{2,300*18}}}, 
		walkrunshadow={
			[1]={{1,1},{20,1}},
			[2]={{1,300*18},{20,300*18}}
		},
		fastwalkrun_p={{{1,9},{30,40}},{{1,300*18},{2,300*18}}},
		fatallystrikeres_p={{{1,1},{40,40},{41,41}},{{1,300*18},{30,300*18}}}, 
	}
	SKILLS.cangsong_yingke={ --²ÔËÉÓ­¿Í
...
--	},
SKILLS.duoming_lianhuan={ --¶áÃüÁ¬»·ÈýÏÉ½£
...
--		skill_cost_v={{{1,30},{20,35}}}
	...
	SKILLS.duoming_start={ --Ö÷¶¯¸¨Öú¶áÃüÁ¬»·ÈýÏÉ½£
		autoreplyskill={{{1,(1*65536 + 1363)*256 + 1},{20,(1*65536 + 1363)*256 + 20},{21,(1*65536 + 1363)*256 + 21}},{{1,10*60*18},{20,10*60*18}},{{1,5*18*256 + 1},{20,5*18*256 + 10},{31,5*18*256 + 10},{32,5*18*256 + 10}}},
	...
	SKILLS.zixia_xiaoguo={ --×ÏÏ¼½£ÆøµÄÐ§¹û
...
--		skill_cost_v={{{1,30},{20,35}}}
	...
	SKILLS.jiujian_start={ --Ö÷¶¯¸¨Öú¾Å½£ºÏÒ»
	...
	SKILLS.haoran_zhiqi={ --ºÆÈ»Ö®Æø
		addblockrate={
			[1]={{1,10},{20,3},{21,3}},
			[2]={{1,-1},{20,-1}},
			[3]={{1,1},{19,1},{20,2},{40,3},{41,3}},
		},
		--anti_coldres_yan_p={{{1,1},{40,20},{41,20}},{{1,-1},{20,-1}}},
	}
	SKILLS.wuji_jianqi1={ --ÎÞ¼«½£Æø1
		...
		SKILLS.qingfeng_songshuang={ --Çå·çËÍË¬
		...
		-- [VHTD 02/09v] bo buff cong % vao 1382 - ha luc tay noi cong theo yeu cau chu
			--addskilldamage1={
				--[1]={{1,1382},{2,1382}},
				--[3]={{1,1},{20,60},{31,70}}
			--},
	...
	SKILLS.shenguang_xuanrao={ --Ä¦ÔÆ½£Æø
	...
	SKILLS.qisha_qichang2={ --ÆßÉ±Æø³¡2
		candetonate1={
			[1]={{1,419*256+0},{2,419*256+0}},
			[3]={{1,360},{26,360},{31,360},{32,360}},
		},
	...
	SKILLS.shenguang_xuanrao1={ --Éñ¹âÐýÈÆ
		candetonate1={
			[1]={{1,419*256+0},{2,419*256+0}},
	...
	SKILLS.new_wuji={ --ÐÂÎÞ¼«½£Æø£¬ÉÏÃæµÄÎÞ¼«½£Æø×÷·Ï
	...
	SKILLS.pishi_poyu={ --ÅüÊ¯ÆÆÓñ neihuashan150
		seriesdamage_p={{{1,40},{15,40},{20,80},{21,82}}},
		colddamage_v={
			[1]={{1,200},{40,8000},{41,8000}},
			[3]={{1,200},{40,8000},{41,8000}},
			--[1]={{1,160},{25,12000*1.2},{40,24000*1.5}},  
   			--[3]={{1,160},{25,12000*1.2},{40,24000*1.5}},  
		},
		fatallystrike_p={{{1,0},{27,0},{28,1},{36,5},{37,5}}},
		skill_misslenum_v={{{1,1},{2,1},{11,2},{12,2},{20,3},{21,3},{35,4},{36,4}}},
