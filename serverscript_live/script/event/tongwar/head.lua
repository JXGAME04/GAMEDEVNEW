...
function tongwar_addtitle(n_title)
	...
	if GetSkillState(1485) ~= -1 then
		RemoveSkillState(1485)
	end

	Title_AddTitle(n_title, 2, nTime);
	-- [FIX 25/08] noi sang he JX1 de danh hieu HIEN that (105->292, 106->293).
	if (n_title == 105) then
		SetPlayerTitle(292, nTime, 0)
	elseif (n_title == 106) then
		SetPlayerTitle(293, nTime, 0)
	end
...
function tongwar_enemy()
	...
	if (nDate ~= 29 and nDate ~= 30 and nDate ~= 31 and nDate ~= 1 and nDate ~= 2 and nDate ~= 3 and nDate ~= 5) then
