...
function VT_ADM_CaNhan()
	SayEx({"<color=yellow>Nh¸nh c¸ nh©n 1-9 sao<color>: cÊp 120 trë lªn, cã m«n ph¸i, 10:00-23:00, 3 lÇn mét ngµy, 5 lÇn lµm míi miÔn phÝ. NhËn ë ¤ng chñ Tiªu côc (Long M«n trÊn), xuÊt ph¸t ë Tiªu S­ ®iÓm ®Çu, tr¶ ë Tiªu S­ ®iÓm cuèi trong 30 phót.",
