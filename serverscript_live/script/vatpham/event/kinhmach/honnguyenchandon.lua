...
Include("\\script\\lib\\lib_task.lua")	-- TASK_CHANGNGUYENDAN
IncludeLib("SETTING");
...
--	end
	...
	PlayerFunLib:AddTask(TASK_CHANGNGUYENDAN,tbVngZenYuan.nCountZenYuan)	-- JX1: diem Chan Nguyen kinh mach = task 362 (Linux 4000)
	tbLog:PlayerActionLog("SuDungHonNguyenChanDon", format("NhanDuoc%dDiemChanNguyen", tbVngZenYuan.nCountZenYuan), format("Ch©n nguyªn hiÖn t¹i %d", GetTask(TASK_CHANGNGUYENDAN)))
