...
ITEM_TO_LOG =
{
	...
	{ 6, 1, 121, "Phóc Duyªn Lé (TiÓu) " },
	{ 6, 1, 122, "Phóc Duyªn Lé (Trung) " },
	{ 6, 1, 123, "Phóc Duyªn Lé (§¹i) " },
	{ 6, 1, 397, "ThÇn bİ kho¸ng th¹ch" },
}
...
COMMON_SUM_BASE_VAL = 20000000 / SUM_UNIT;		-- ĞèÒª¼ÆÈëÆÕÍ¨ÎïÆ·¼ÛÖµÁ¿»ã×ÜÖµµÄ×îµÍ¼ÛÖµÁ¿
COMMON_SUM_MAX_VAL = 10000000000 / SUM_UNIT;	-- Ã¿ÈÕÔÊĞí[ºÏ³É]µÄÆÕÍ¨ÎïÆ·¼ÛÖµÁ¿»ã×ÜÖµµÄ×î´óÖµ£¬µ½´ï´ËÖµ½«²»ÔÙÔÊĞí½øĞĞÈÎºÎ[ºÏ³É]²Ù×÷
GOLD_SUM_BASE_VAL = 100000000 / SUM_UNIT;		-- ĞèÒª¼ÆÈë»Æ½ğ×°±¸¼ÛÖµÁ¿»ã×ÜÖµµÄ×îµÍ¼ÛÖµÁ¿
GOLD_SUM_MAX_VAL = 10000000000 / SUM_UNIT;		-- Ã¿ÈÕÔÊĞí[ºÏ³É]µÄ»Æ½ğ×°±¸¼ÛÖµÁ¿»ã×ÜÖµµÄ×î´óÖµ£¬µ½´ï´ËÖµ½«²»ÔÙÔÊĞí½øĞĞÈÎºÎ[ºÏ³É]²Ù×÷
...
function defFinalCompound( arynNecessaryItemIdx, arynAlternativeItemIdx, nSrcItemValSum, aryDesItemInfo, arydDesItemVal )
