-- ================================================================================================
-- [HE THONG] script/npclevelscript/newanimal.lua
...
-- Ham (dong): Line (12), Conic (27), Extrac (45), Link (62), GetParam (98), GetNpcLevelData (120), GetNpcKeyData (397), GetData (433), GetExp (440), GetLife (445), GetAttackRating (450), GetDefense (519), GetMinDamage (587), GetMaxDamage (655)
