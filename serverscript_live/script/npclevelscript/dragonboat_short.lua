-- ================================================================================================
-- [HE THONG] script/npclevelscript/dragonboat_short.lua
...
-- Ham (dong): Line (12), Conic (27), Extrac (45), Link (62), GetParam (98), GetNpcLevelData (120), GetNpcKeyData (336), GetData (372), GetExp (379), GetLife (384), GetAttackRating (389), GetDefense (458), GetMinDamage (526), GetMaxDamage (594)
