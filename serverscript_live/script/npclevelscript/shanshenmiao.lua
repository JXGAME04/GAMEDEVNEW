-- ================================================================================================
-- [HE THONG] script/npclevelscript/shanshenmiao.lua
...
-- Ham (dong): Line (12), Conic (27), Extrac (45), Link (62), GetParam (98), GetNpcLevelData (120), GetNpcKeyData (348), GetData (384), GetExp (391), GetLife (396), GetAttackRating (401), GetDefense (470), GetMinDamage (538), GetMaxDamage (606)
