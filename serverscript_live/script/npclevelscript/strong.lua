-- ================================================================================================
-- [HE THONG] script/npclevelscript/strong.lua
...
-- Ham (dong): Line (12), Conic (27), Extrac (45), Link (62), GetParam (99), GetNpcLevelData (121), GetNpcKeyData (196), GetData (226), GetExp (233), GetLife (301), GetAttackRating (370), GetDefense (439), GetMinDamage (507), GetMaxDamage (575)
