-- ================================================================================================
-- [HE THONG] script/npclevelscript/standard.lua
...
-- Ham (dong): Line (12), Conic (27), Extrac (45), Link (62), GetParam (98), GetNpcLevelData (120), GetNpcKeyData (365), GetData (407), GetExp (414), GetLife (482), GetAttackRating (551), GetDefense (620), GetMinDamage (688), GetMaxDamage (756)
