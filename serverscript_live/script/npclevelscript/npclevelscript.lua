-- ================================================================================================
-- [HE THONG] script/npclevelscript/npclevelscript.lua
-- Muc dich  : AI + THUOC TINH NPC MAC DINH theo cap (C++ KCore.cpp:588 nap TRUC TIEP - KHONG doi cho). 14 ham chuan: OnCreate, GetAttrib...
-- Duoc nap  : engine nap luc boot (moi tep .lua = 1 lua_State rieng) + C++ goi truc tiep theo ten tep
-- Ham (dong): Line (12), Conic (27), Extrac (45), Link (62), GetParam (98), GetNpcLevelData (120), GetNpcKeyData (219), GetData (249), GetExp (256), GetLife (324), GetAttackRating (393), GetDefense (462), GetMinDamage (530), GetMaxDamage (598)
...
if(StyleName=="Level5") then -- script viet hoa By http://tranhba.com  lÊy ra npc cÊp bËc 
return ParamStr 
end 
if(StyleName=="AIMode") then -- script viet hoa By http://tranhba.com  chñ ®éng trë vÒ m¸u AI m« thøc 
return ParamStr 
end 
...
if(StyleName=="Skill1") then -- script viet hoa By http://tranhba.com  trë vÒ m¸u # trÞ liÖu thuËt 
return ParamStr 
end 
if(StyleName=="Skill1" or StyleName=="Skill2" or StyleName=="Skill3" or StyleName=="Skill4") then -- script viet hoa By http://tranhba.com  gÇn tr×nh ngò hµnh c«ng kÝch 
return ParamStr 
end 
