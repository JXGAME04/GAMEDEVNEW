-- ================================================================================================
-- [HE THONG] script/npclevelscript/task_normalnpc.lua
...
-- Ham (dong): Line (12), Conic (27), Extrac (45), Link (62), GetParam (98), GetNpcLevelData (120), GetNpcKeyData (360), GetData (390), GetExp (397), GetLife (402), GetAttackRating (407), GetDefense (476), GetMinDamage (544), GetMaxDamage (612)
