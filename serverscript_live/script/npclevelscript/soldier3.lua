-- ================================================================================================
-- [HE THONG] script/npclevelscript/soldier3.lua
...
-- Ham (dong): Line (12), Conic (27), Extrac (45), Link (62), GetParam (98), GetNpcLevelData (120), GetNpcKeyData (329), GetData (365), GetExp (372), GetLife (377), GetAttackRating (391), GetDefense (460), GetMinDamage (528), GetMaxDamage (596)
