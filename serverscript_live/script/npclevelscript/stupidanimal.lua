-- ================================================================================================
-- [HE THONG] script/npclevelscript/stupidanimal.lua
...
-- Ham (dong): Line (12), Conic (27), Extrac (45), Link (62), GetParam (98), GetNpcLevelData (120), GetNpcKeyData (171), GetData (201), GetExp (208), GetLife (276), GetAttackRating (345), GetDefense (414), GetMinDamage (482), GetMaxDamage (550)
