-- ================================================================================================
-- [HE THONG] script/npclevelscript/npc_fenglingdunan.lua
...
-- Ham (dong): Line (12), Conic (27), Extrac (45), Link (62), GetParam (98), GetNpcLevelData (120), GetNpcKeyData (354), GetData (390), GetExp (397), GetLife (402), GetAttackRating (407), GetDefense (476), GetMinDamage (544), GetMaxDamage (612)
