-- ================================================================================================
-- [HE THONG] script/npclevelscript/task_goldennpc.lua
...
-- Ham (dong): Line (12), Conic (27), Extrac (45), Link (62), GetParam (98), GetNpcLevelData (120), GetNpcKeyData (357), GetData (387), GetExp (394), GetLife (399), GetAttackRating (404), GetDefense (473), GetMinDamage (541), GetMaxDamage (609)
