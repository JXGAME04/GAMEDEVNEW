-- ================================================================================================
-- [HE THONG] script/npclevelscript/newnpc.lua
...
-- Ham (dong): Line (12), Conic (27), Extrac (45), Link (62), GetParam (98), GetNpcLevelData (120), GetNpcKeyData (364), GetData (400), GetExp (407), GetLife (412), GetAttackRating (417), GetDefense (486), GetMinDamage (554), GetMaxDamage (622)
