-- ================================================================================================
-- [HE THONG] script/npclevelscript/army.lua
...
-- Ham (dong): Line (12), Conic (27), Extrac (45), Link (62), GetParam (98), GetNpcLevelData (125), GetNpcKeyData (200), GetData (230), GetExp (237), GetLife (305), GetAttackRating (374), GetDefense (443), GetMinDamage (511), GetMaxDamage (579)
