-- ================================================================================================
-- [HE THONG] script/npclevelscript/called_soldier1.lua
...
-- Ham (dong): Line (12), Conic (27), Extrac (45), Link (62), GetParam (98), GetNpcLevelData (120), GetNpcKeyData (368), GetData (404), GetExp (411), GetLife (416), GetAttackRating (430), GetDefense (499), GetMinDamage (567), GetMaxDamage (635)
