-- ================================================================================================
-- [HE THONG] script/npclevelscript/npc_changgemenarea.lua
...
-- Ham (dong): Line (12), Conic (27), Extrac (45), Link (62), GetParam (98), GetNpcLevelData (120), GetNpcKeyData (299), GetData (335), GetExp (342), GetLife (347), GetAttackRating (352), GetDefense (421), GetMinDamage (489), GetMaxDamage (557)
