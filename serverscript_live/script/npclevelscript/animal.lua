-- ================================================================================================
-- [HE THONG] script/npclevelscript/animal.lua
...
-- Ham (dong): Line (12), Conic (27), Extrac (45), Link (62), GetParam (98), GetNpcLevelData (120), GetNpcKeyData (397), GetData (439), GetExp (446), GetLife (514), GetAttackRating (583), GetDefense (652), GetMinDamage (720), GetMaxDamage (788)
