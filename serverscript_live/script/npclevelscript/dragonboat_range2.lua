-- ================================================================================================
-- [HE THONG] script/npclevelscript/dragonboat_range2.lua
...
-- Ham (dong): Line (12), Conic (27), Extrac (45), Link (62), GetParam (98), GetNpcLevelData (120), GetNpcKeyData (381), GetData (417), GetExp (424), GetLife (429), GetAttackRating (434), GetDefense (503), GetMinDamage (571), GetMaxDamage (639)
