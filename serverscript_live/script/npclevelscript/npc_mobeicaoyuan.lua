-- ================================================================================================
-- [HE THONG] script/npclevelscript/npc_mobeicaoyuan.lua
...
-- Ham (dong): Line (12), Conic (27), Extrac (45), Link (62), GetParam (98), GetNpcLevelData (120), GetNpcKeyData (305), GetData (341), GetExp (348), GetLife (353), GetAttackRating (358), GetDefense (427), GetMinDamage (495), GetMaxDamage (563)
...
if(StyleName=="Skill2" or StyleName=="Skill3") then -- script viet hoa By http://tranhba.com  gÇn tr×nh ngò hµnh c«ng kÝch 
if(Series==0) then 
return 419 
...
if(StyleName=="Skill4" ) then -- script viet hoa By http://tranhba.com  tÇm xa ngò hµnh c«ng kÝch 
if(Level < 60 ) then -- script viet hoa By http://tranhba.com 60 cÊp tr­íc kia v« tÇm xa c«ng kÝch 
return 418 
end 
if(Series==0) then 
return 424 
