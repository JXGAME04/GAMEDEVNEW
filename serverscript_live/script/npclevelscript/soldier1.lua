-- ================================================================================================
-- [HE THONG] script/npclevelscript/soldier1.lua
...
-- Ham (dong): Line (12), Conic (27), Extrac (45), Link (62), GetParam (98), GetNpcLevelData (120), GetNpcKeyData (327), GetData (363), GetExp (370), GetLife (375), GetAttackRating (389), GetDefense (458), GetMinDamage (526), GetMaxDamage (594)
