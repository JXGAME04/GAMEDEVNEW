-- ================================================================================================
-- [HE THONG] script/npclevelscript/tasknpc.lua
...
-- Ham (dong): Line (12), Conic (27), Extrac (45), Link (62), GetParam (98), GetNpcLevelData (120), GetNpcKeyData (359), GetData (401), GetExp (408), GetLife (413), GetAttackRating (482), GetDefense (551), GetMinDamage (619), GetMaxDamage (687)
