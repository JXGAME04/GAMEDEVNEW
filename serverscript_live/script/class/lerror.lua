-- ================================================================================================
-- [HE THONG] script/class/lerror.lua
-- Muc dich  : Bao loi kieu JX2 (lerror).
-- Duoc nap  : Include tu 1 tep (vd ktabfile.lua); engine nap moi .lua thanh 1 lua_State luc boot
