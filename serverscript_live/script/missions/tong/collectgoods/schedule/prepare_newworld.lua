...
function OnNewWorld(szParam)
	...
	local nPlayerCount = GetMSPlayerCount(COLLG_PREPAREMISSIONID)	-- [FIX 25/08] nhom 0 KHONG phai 'tat ca' (nhanh do bi comment trong engine,
	-- KMission GetGroupPlayerCount) -> luon tra 0, tran nguoi vo hieu; bo tham so
	-- nhom de dem TAT CA (ScriptFuns.cpp:11896-11899), cung khuon va PLD 8ccc5d32;
