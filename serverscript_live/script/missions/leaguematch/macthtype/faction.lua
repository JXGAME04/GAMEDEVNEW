...
local WLLS_DATA = {
	...
	match_type = {
		...
		},
		{
			name = "C«n L«n",
			level = 2,
			ladder = nTmpLadderBase + 20,
			map = {{558, 579, 559, ""}},
		},
		{
			name = " Hoa S¬n",
			level = 2,
			ladder = nTmpLadderBase + 21,
			map = {{991, 993, 992, ""}},
		},
	},
	...
	award_rank = {
		{	--ÅÅÐÐ½±Àø£¬ÐÂÐã
			...
			{1, 8000, nil, {tbProp=tbLianSaiLiBao,nCount=16}, {tbProp={6,1,4550,1,0,0}, nCount=16}},	--µÚ1Ãû
			{2, 6000, nil, {tbProp=tbLianSaiLiBao,nCount=12}, {tbProp={6,1,4550,1,0,0}, nCount=12}},	--µÚ2Ãû
			{3, 4000, nil, {tbProp=tbLianSaiLiBao,nCount=8}, {tbProp={6,1,4550,1,0,0}, nCount=8}},	--µÚ3Ãû
			{4, 3000, nil, {tbProp=tbLianSaiLiBao,nCount=6}, {tbProp={6,1,4550,1,0,0}, nCount=6}},	--µÚ4Ãû
			{8, 2000, nil, {tbProp=tbLianSaiLiBao,nCount=4}, {tbProp={6,1,4550,1,0,0}, nCount=4}},	--µÚ5-8Ãû
			{16, 1000, nil, {tbProp=tbLianSaiLiBao,nCount=2}, {tbProp={6,1,4550,1,0,0}, nCount=2}},	--µÚ9-16Ãû
			{32, 500, nil, {tbProp=tbLianSaiLiBao,nCount=1}, {tbProp={6,1,4550,1,0,0}, nCount=1}},	--µÚ17-32Ãû
		}
	},
	...
	text_main = {	--officerÖ÷¶Ô»°£¨Ä©Î²²îÒì²¿·Ö£©
		"Lo¹i h×nh thi ®Êu Vâ L©m Liªn §Êu T©n Tó lÇn nµy lµ §Êu §¬n M«n Ph¸i, lùa chän nh©n tµi cña 11 ®¹i m«n ph¸i, c¸c vÞ ph¶i cè g¾ng hÕt søc!",
