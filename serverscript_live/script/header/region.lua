-- ================================================================================================
-- [HE THONG] script/header/region.lua
-- Muc dich  : VUNG (region) ban do, kiem tra toa do trong vung.
-- Duoc nap  : Include tu 1 tep (vd script_protocol.lua); engine nap moi .lua thanh 1 lua_State luc boot
-- Ham (dong): PermitRegion (240), GetDirection (260)
