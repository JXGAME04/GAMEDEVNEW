...
-- [PB 30/08] dong nay TRUOC DAY ghi cung 30 ngay, ghi de len gia tri
-- doc tu cau hinh o partner_reward.lua:27 (thu tu nap luon la reward ->
-- reward2), lam cong tac BDH_THOIHAN_DANHHIEU_NGAY vo tac dung.
-- [VALOI 30/08] partner_reward2.lua bi engine NAP DOC LAP luc khoi dong
-- (dong 'Total ScriptLoaded'), khong chi qua reward_partner.lua. Luc do
-- BDH_CFG chua ton tai (no khai trong partner_reward.lua) -> ScriptError 4.
-- Chep nguyen khuon cua partner_reward.lua de tep nay TU DU.
...
TITLETIME = BDH_CFG("BDH_THOIHAN_DANHHIEU_NGAY", 30) * 24 * 60 * 60 * 18 * 36  --称号技能的执行时间
