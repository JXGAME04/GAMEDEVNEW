...
TEMBUGBEAR_EXP =tonumber( TabFile_GetCell( "tollprize" ,5 ,"bug_exp"))  --Ð¡¹Ö¾­Ñé
TEMBUGBEAR_MAPID= 390  --É½ÉñÃíµÄµØÍ¼id
TEMBUGBEAR_MESSENGEREXP=tonumber( TabFile_GetCell( "tollprize" ,5 ,"bug_jifen"))  --Ð¡¹Ö¾­Ñé
