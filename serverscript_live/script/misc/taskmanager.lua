...
TaskManager.tbTaskGroup = 
{
	...
	[4] = 
		...
		-- date:2013-12-23~2014-01-15; VN2013圣诞节活动by唐兆宁
	{
		nCurrentVersion = 5,
		nVersionTask = 914,
	...
	[5] = 
	{
		...
		-- date:2014-01-20 00:00~2014-02-23 00:00	JXVN春节活动
		nVersionTask = 934,
	...
	[14] = 
	{
		...
		--2013-12-02~2013-12-30 VN12月活动 by唐兆宁
		nCurrentVersion = 2,
		nVersionTask = 1501,
...
function TaskManager:ResetUseGroup()
	for nGroupId, bUse in pairs(self.tbUseGroup) do
		if bUse == 1 then
			self:ResetTaskGroup(nGroupId)
		end
	end
...
function TaskManager:Create(nGroupId, nVersion)
	...
	local tb = {}
	for key , value in pairs(TaskGroup) do
