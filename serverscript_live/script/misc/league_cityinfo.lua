...
-- ==== DOT E (E5) SHIM: 2 dinh nghia goc THIEU (nil-call duong thuong tuan
-- cua citywar_function.lua:156,193 - bang xu ly bug goc, KEHOACH muc 3) ====
CITYINFO_LEAGUETASK_COUNT = 4
function add_citybonus_task(nCityID, nTsk, nDelta)
	local strLeagueName = cityID2LeagueName(nCityID)
	local nCur = LG_GetLeagueTask(LEAGUETYPE_CITYINFO, strLeagueName, nTsk)
	LG_ApplySetLeagueTask(LEAGUETYPE_CITYINFO, strLeagueName, nTsk, nCur + nDelta, "", "")
end
