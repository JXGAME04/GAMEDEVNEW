...
function go_atone()
	...
	logHoatDong("Name:"..GetName().."\tAccount:"..GetAccount().."\t bÞ nhèt vµo ®¹i lao cóp trªn ng­êi tÊt c¶ tiÒn mÆt "..my_money.." luong")
end 
