...
-- [DONDATAU 30/08] he Da Tau CU da go
...
function godatau()
	...
	-- [DONDATAU 30/08] da go nhanh du phong cua he Da Tau CU (32 dong).
	-- He do da go han; lib_ham.lua:261-267 reset MOI NGAY cac task
	-- T_TIMDOCHI / T_TIMMATCHI / T_DanhQuai / T_TIENDONV nen khong
	-- nhan vat nao ket lai. He dang chay = tasklink (nhanh o tren).
