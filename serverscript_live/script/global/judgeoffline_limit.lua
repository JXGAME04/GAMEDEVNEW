-- ================================================================================================
-- [HE THONG] script/global/judgeoffline_limit.lua
-- Muc dich  : Gioi han offline / phan xu.
-- Duoc nap  : Include tu 1 tep (vd boss.lua); engine nap moi .lua thanh 1 lua_State luc boot
-- Ham (dong): offlineCheckPermitRegion (411), StallCheckPermitRegion (431), getDirection (442)
