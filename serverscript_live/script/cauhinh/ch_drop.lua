-- ================================================================================================
-- [HE THONG] script/cauhinh/ch_drop.lua
-- Muc dich  : CAU HINH ROI DO (ti le, bang roi).
-- Duoc nap  : Include tu 2 tep (vd ch_all.lua, lib_sukien.lua); engine nap moi .lua thanh 1 lua_State luc boot
