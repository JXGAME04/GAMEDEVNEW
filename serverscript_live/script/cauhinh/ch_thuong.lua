-- ================================================================================================
-- [HE THONG] script/cauhinh/ch_thuong.lua
-- Muc dich  : BANG PHAN THUONG (id vat pham, so luong).
-- Duoc nap  : Include tu 12 tep (vd ch_all.lua, ch_thuong_lib.lua, tieudau.lua, lib.lua); engine nap moi .lua thanh 1 lua_State luc boot
...
-- [BOLDHC 30/08] bo khoa LDHC_EXP_COMAT: hoat dong Loi Dai Hon Chien da bo han
-- [BOLDHC 30/08] bo khoa LDHC_SL_HOMACH_COMAT: hoat dong Loi Dai Hon Chien da bo han
-- [BOLDHC 30/08] bo khoa LDHC_EXP_QUANQUAN: hoat dong Loi Dai Hon Chien da bo han
-- [BOLDHC 30/08] bo khoa LDHC_SL_MANH_HOANGKIM: hoat dong Loi Dai Hon Chien da bo han
