...
ScriptProtocol.KE_SCRIPT_PROTOCOL = 
{
	...
	-- [DAUGIA 04/09] dau gia (2.0 + OPENWND rieng cua JX1)
	...
	"emSCRIPT_PROTOCOL_AUCTION_REQUEST_OFFERENGLISHPRICE",
	"emSCRIPT_PROTOCOL_AUCTION_REQUEST_OFFERDUTCHPRICE",
	...
	-- [CL 04/09 DOT2] Chien Lenh: 3 yeu cau client -> may chu, 7 goi may chu -> client (them CUOI, hai ben y het)
	"emSCRIPT_PROTOCOL_CL_REQUEST_OPEN",
	"emSCRIPT_PROTOCOL_CL_REQUEST_GETAWARD",
	"emSCRIPT_PROTOCOL_CL_REQUEST_GETMISSION",
	"emSCRIPT_PROTOCOL_CL_SHOWICON",
	"emSCRIPT_PROTOCOL_CL_INFO",
	"emSCRIPT_PROTOCOL_CL_AWARD",
	"emSCRIPT_PROTOCOL_CL_MISSION",
	"emSCRIPT_PROTOCOL_CL_CLEAR",
	"emSCRIPT_PROTOCOL_CL_REFRESH",
	"emSCRIPT_PROTOCOL_CL_MSG",
}

function ScriptProtocol:_InitProtocolEnum()
	for key, v in pairs(self.KE_SCRIPT_PROTOCOL) do
		self[v] = key
	end
end
...
function ScriptProtocol_RecvInState(nHandle, szFun, ...) local arg = {n = select("#", ...), ...};
	local tbFormat = {}
	for i = 1, arg.n do
